...
<?php $__env->startSection('meta'); ?>
    ...
    <?php if($page->focus_keyword): ?>
        <meta name="keywords" content="<?php echo e($page->focus_keyword); ?>">
    <?php endif; ?>
    ...
    <meta property="og:url" content="<?php echo e(url('/explore/'.$page->slug)); ?>">
    <?php if($page->featured_image): ?>
        <meta property="og:image" content="<?php echo e(asset('storage/'.$page->featured_image)); ?>">
    <?php endif; ?>
    <link rel="canonical" href="<?php echo e(url('/explore/'.$page->slug)); ?>">
...
<div class="bg-white">
    ...
    <div class="sp-hero">
        <?php if($page->featured_image): ?>
            <img src="<?php echo e(asset('storage/'.$page->featured_image)); ?>"
            ...
            <?php if($page->focus_keyword): ?>
                <div>
                    <span class="sp-hero__keyword">
                        ...
                        <?php echo e($page->focus_keyword); ?>

                    </span>
                </div>
            <?php endif; ?>
            <h1 class="sp-hero__title"><?php echo e($page->title); ?></h1>
            <?php if($page->meta_description): ?>
                <p class="sp-hero__desc"><?php echo e($page->meta_description); ?></p>
            <?php endif; ?>
        </div>
    </div>
        ...
        <div class="sp-main">
            ...
            <?php $__currentLoopData = $page->blocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $block): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php if($block->block_type === 'heading'): ?>
                    <?php $level = $block->heading_level ?? 'h2'; ?>
                    <?php $slug  = \Illuminate\Support\Str::slug($block->content); ?>
                    <?php if($level === 'h1'): ?>
                        <h1 id="<?php echo e($slug); ?>" class="sp-h1"><?php echo e($block->content); ?></h1>
                    <?php elseif($level === 'h2'): ?>
                        <h2 id="<?php echo e($slug); ?>" class="sp-h2"><?php echo e($block->content); ?></h2>
                    <?php elseif($level === 'h3'): ?>
                        <h3 id="<?php echo e($slug); ?>" class="sp-h3"><?php echo e($block->content); ?></h3>
                    <?php elseif($level === 'h4'): ?>
                        <h4 class="sp-h4"><?php echo e($block->content); ?></h4>
                    <?php elseif($level === 'h5'): ?>
                        <h5 class="sp-h5"><?php echo e($block->content); ?></h5>
                    <?php else: ?>
                        <h6 class="sp-h6"><?php echo e($block->content); ?></h6>
                    <?php endif; ?>

                
                <?php elseif($block->block_type === 'text'): ?>
                    <div class="sp-text"><?php echo $block->content; ?></div>

                
                <?php elseif($block->block_type === 'image' && $block->images->count() > 0): ?>
                    <?php if($block->images->count() === 1): ?>
                        <div class="sp-img-single">
                            <figure>
                                <img src="<?php echo e(asset('storage/'.$block->images->first()->image_path)); ?>"
                                     alt="<?php echo e($block->images->first()->alt_text ?? $page->title); ?>"
                                     loading="lazy">
                                <?php if($block->images->first()->alt_text): ?>
                                    <figcaption><?php echo e($block->images->first()->alt_text); ?></figcaption>
                                <?php endif; ?>
                            </figure>
                        </div>
                    <?php else: ?>
                ...
                <?php elseif($block->block_type === 'links' && $block->links->count() > 0): ?>
                    <div class="sp-inline-links">
                        <?php $__currentLoopData = $block->links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e($link->linked_page_url); ?>" class="sp-inline-link">
            ...
            <div class="sp-cta">
                ...
                <a href="<?php echo e(route('contact')); ?>" class="sp-cta__btn">
                    Get a Free Quote
                ...
                <div class="sp-toc">
                    ...
                    <ul class="sp-toc__list">
                        <?php $__currentLoopData = $headings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <a href="#<?php echo e(\Illuminate\Support\Str::slug($h->content)); ?>"
                                   class="<?php echo e($h->heading_level === 'h3' ? 'sp-toc--h3' : ''); ?>">
                                    <?php echo e($h->content); ?>
