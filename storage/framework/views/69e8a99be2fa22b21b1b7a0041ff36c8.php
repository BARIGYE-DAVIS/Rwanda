<?php $__env->startSection('title', 'Uganda & Rwanda Safari Packages 2026 | Budget Gorilla Trekking & Wildlife Tours'); ?>
<?php $__env->startSection('meta_description', 'Browse affordable Uganda and Rwanda safari packages from $1,300. Gorilla trekking Bwindi, chimp tracking Kibale, Nile game drives Murchison Falls. All-inclusive, small groups, local guides.'); ?>
<?php $__env->startSection('meta_keywords', 'Uganda Rwanda safari packages 2026, budget gorilla trekking packages, affordable Uganda safari, Bwindi trekking package, Kibale chimp tracking tour, Murchison Falls safari, Queen Elizabeth NP package, Rwanda Volcanoes safari, small group Uganda safari, all-inclusive safari East Africa'); ?>
<?php $__env->startSection('canonical', 'https://rwandabudgetsafaris.com/tours'); ?>

<?php $__env->startSection('og_title', 'Uganda & Rwanda Safari Packages 2026 — All-Inclusive, Budget to Luxury'); ?>
<?php $__env->startSection('og_description', 'Gorilla trekking, chimp tracking, Big Five game drives and Nile cruises across Uganda and Rwanda. Packages from $1,300 with permits, lodges and local guides included.'); ?>
...
<header id="tours-hero" class="relative w-full overflow-hidden" style="height:460px;">
    ...
    <img id="hero-img"
         src="<?php echo e($headerImage ?? asset('images/GORILLA.jpg')); ?>"
        ...
        <nav aria-label="Breadcrumb">
            <ol class="flex items-center gap-2 text-xs sm:text-sm text-white/50"
                ...
                <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                    <a href="<?php echo e(route('index')); ?>" itemprop="item" class="hover:text-white transition-colors">
...
<div class="w-full overflow-x-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="max-w-3xl mx-auto text-center mb-10">
                ...
                <p class="mt-4 text-gray-600 text-base sm:text-lg leading-relaxed">
                    ...
                    <a href="<?php echo e(route('contact')); ?>" class="text-green-600 font-semibold hover:underline">
                        contact us
                    </a>
            ...
            <div class="flex flex-wrap justify-center gap-2 mb-10">
                ...
                <span class="bg-green-50 border border-green-200 text-green-800 text-xs font-semibold
                             px-4 py-1.5 rounded-full"><?php echo e($dest); ?></span>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-3 mb-3 sm:mb-4">
                <div>
                    ...
                    <p class="text-gray-400 text-xs mt-0.5"><?php echo e($tours->total()); ?> packages available</p>
                </div>
            ...
            <div id="filter-form-wrap" class="hidden md:block">
                <form id="filter-form" method="GET" action="<?php echo e(route('tours.index')); ?>#tour-filters"
                    ...
                    <div class="w-full md:flex-1 md:min-w-[120px]">
                        <label class="block text-xs font-medium text-gray-500 mb-1 md:hidden"><?php echo e($f['label']); ?></label>
                        <select name="<?php echo e($f['name']); ?>"
                            ...
                            <option value=""><?php echo e($f['placeholder']); ?></option>
                            <?php $__currentLoopData = $f['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($item); ?>" <?php echo e(request($f['name'])==$item ? 'selected' : ''); ?>>
                                    <?php echo e($f['fmt']==='ucfirst' ? ucfirst($item) : $item); ?>
                    ...
                    <div class="w-full md:flex-1 md:min-w-[120px]">
                        ...
                        <select name="price_range"
                            ...
                            <?php if($priceRanges['min'] > 0 && $priceRanges['max'] > 0): ?>
                                <?php
                                ...
                                ?>
                                <?php $__currentLoopData = $ranges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>[$mn,$mx]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($key); ?>" <?php echo e(request('price_range')==$key ? 'selected' : ''); ?>>
                                        $<?php echo e(number_format($mn)); ?> – $<?php echo e(number_format($mx)); ?>
                    ...
                    <div class="w-full md:flex-1 md:min-w-[120px]">
                        ...
                        <select name="sort"
                            ...
                            <?php $__currentLoopData = [
                                ...
                                <option value="<?php echo e($val); ?>" <?php echo e(request('sort')==$val ? 'selected' : ''); ?>><?php echo e($lbl); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    ...
                    <div class="flex gap-2 md:hidden">
                        ...
                        <?php if(request()->hasAny(['category','type','destination','duration','price_range','sort'])): ?>
                            <a href="<?php echo e(route('tours.index')); ?>#tour-filters"
                    ...
                    <div class="mt-3 flex flex-wrap gap-2 items-center">
                        ...
                        <?php if(request('category')): ?>
                            <span class="inline-flex items-center bg-green-100 text-green-800 px-2.5 py-1 rounded-full text-xs font-medium">
                                ...
                                <a href="<?php echo e(request()->fullUrlWithQuery(['category'=>null])); ?>#tour-filters" class="ml-1.5 font-bold opacity-60 hover:opacity-100">&times;</a>
                            </span>
                        <?php endif; ?>
                        <?php if(request('type')): ?>
                            <span class="inline-flex items-center bg-blue-100 text-blue-800 px-2.5 py-1 rounded-full text-xs font-medium">
                                ...
                                <a href="<?php echo e(request()->fullUrlWithQuery(['type'=>null])); ?>#tour-filters" class="ml-1.5 font-bold opacity-60 hover:opacity-100">&times;</a>
                            </span>
                        <?php endif; ?>
                        <?php if(request('destination')): ?>
                            <span class="inline-flex items-center bg-purple-100 text-purple-800 px-2.5 py-1 rounded-full text-xs font-medium">
                                <?php echo e(request('destination')); ?>

                                <a href="<?php echo e(request()->fullUrlWithQuery(['destination'=>null])); ?>#tour-filters" class="ml-1.5 font-bold opacity-60 hover:opacity-100">&times;</a>
                            </span>
                        <?php endif; ?>
                        <?php if(request('duration')): ?>
                            <span class="inline-flex items-center bg-orange-100 text-orange-800 px-2.5 py-1 rounded-full text-xs font-medium">
                                <?php echo e(request('duration')); ?> <?php echo e(request('duration')==1 ? 'Day' : 'Days'); ?>

                                <a href="<?php echo e(request()->fullUrlWithQuery(['duration'=>null])); ?>#tour-filters" class="ml-1.5 font-bold opacity-60 hover:opacity-100">&times;</a>
                            </span>
                        <?php endif; ?>
                        <?php if(request('price_range')): ?>
                            <span class="inline-flex items-center bg-pink-100 text-pink-800 px-2.5 py-1 rounded-full text-xs font-medium">
                                <?php echo e(ucfirst(str_replace('-',' ',request('price_range')))); ?>

                                <a href="<?php echo e(request()->fullUrlWithQuery(['price_range'=>null])); ?>#tour-filters" class="ml-1.5 font-bold opacity-60 hover:opacity-100">&times;</a>
                            </span>
                        <?php endif; ?>
                        <?php if(request('sort')): ?>
                            <span class="inline-flex items-center bg-gray-100 text-gray-700 px-2.5 py-1 rounded-full text-xs font-medium">
                                <?php echo e(ucfirst(str_replace('_',' ',request('sort')))); ?>

                                <a href="<?php echo e(request()->fullUrlWithQuery(['sort'=>null])); ?>#tour-filters" class="ml-1.5 font-bold opacity-60 hover:opacity-100">&times;</a>
                            </span>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
    ...
    <section id="tours-results" class="py-10 sm:py-14 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="relative h-48 sm:h-56 overflow-hidden shrink-0">
                        <?php if($tour->featured_image): ?>
                            <img src="<?php echo e(asset('storage/'.$tour->featured_image)); ?>"
                                 alt="<?php echo e($tour->title); ?> — Uganda Rwanda safari package"
                    ...
                    <div class="p-4 sm:p-5 flex flex-col flex-1">
                        ...
                        <p class="text-gray-500 text-xs sm:text-sm leading-relaxed line-clamp-2 mb-3 flex-1"
                           itemprop="description">
                            <?php echo e(Str::limit($tour->description, 110)); ?>
                        ...
                        <div class="flex items-center gap-1.5 mb-4 text-xs text-gray-400">
                            ...
                            <span class="line-clamp-1" itemprop="touristType">
                                <?php echo e($tour->destinations ?: 'Uganda & Rwanda, East Africa'); ?>
                        ...
                        <div class="flex items-end justify-between mb-4"
                            ...
                            <div>
                                <?php if($tour->prices && $tour->prices->count() > 0): ?>
                                    ...
                                    <meta itemprop="price" content="<?php echo e($minPrice); ?>">
                        ...
                        <div class="flex gap-2 mt-auto">
                            ...
                            <button onclick="quickBook('<?php echo e($tour->slug); ?>')"
                                    title="Book <?php echo e($tour->title); ?>"
                    ...
                    <div class="flex-shrink-0 w-60 snap-start bg-white rounded-2xl
                        ...
                        <div class="p-3">
                            ...
                            <div class="flex items-center gap-1 mb-2 text-[10px] text-gray-400">
                                ...
                                <span class="line-clamp-1"><?php echo e($tour->destinations ?: 'Uganda & Rwanda'); ?></span>
                            </div>
                            <div class="flex items-center justify-between mb-3">
                                <?php if($tour->prices && $tour->prices->count() > 0): ?>
                                    <?php $minPrice = $tour->prices->min('price'); ?>
                                    <p class="text-sm font-black text-green-600">
                                        $<?php echo e(number_format($minPrice)); ?><span class="text-[10px] font-normal text-gray-400"> /pp</span>
                                    </p>
                                <?php else: ?>
            ...
            <div class="mt-10 flex justify-center">
                <?php echo e($tours->appends(request()->query())->links()); ?>
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden"
                    ...
                    <button class="faq-toggle w-full text-left px-5 sm:px-6 py-4 sm:py-5
                        ...
                        <span class="font-bold text-gray-900 text-sm sm:text-base leading-snug"
                              itemprop="name"><?php echo e($faq['q']); ?></span>
                    ...
                    <div class="faq-answer hidden px-5 sm:px-6 pb-5"
                        ...
                        <p class="text-gray-500 text-sm leading-relaxed" itemprop="text"><?php echo e($faq['a']); ?></p>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
    ...
    <section class="relative py-16 sm:py-24 overflow-hidden">
        <img src="<?php echo e(asset('images/GORILLA.jpg')); ?>" alt="" aria-hidden="true"
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views/tours/index.blade.php ENDPATH**/ ?>