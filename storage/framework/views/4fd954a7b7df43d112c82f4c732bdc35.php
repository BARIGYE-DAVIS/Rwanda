<?php $__empty_1 = true; $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    <tr class="hover:bg-gray-50 transition-colors">
        <td class="px-6 py-4 text-sm text-gray-400 font-mono"><?php echo e(str_pad($loop->iteration, 2, '0', STR_PAD_LEFT)); ?></td>
        <td class="px-6 py-4">
            <p class="text-sm font-semibold text-gray-900"><?php echo e($page->title); ?></p>
        </td>
        ...
        <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap">
            <?php echo e($page->created_at->format('d M Y')); ?>

        </td>
        <td class="px-6 py-4">
            <div class="flex items-center justify-end gap-2">
                <?php if($page->status === 'published'): ?>
                    <a href="<?php echo e(route('seo-pages.show', $page->slug)); ?>"
                       target="_blank"
                ...
                <a href="<?php echo e(route('admin.seo-pages.edit', $page)); ?>"
                ...
                <form action="<?php echo e(route('admin.seo-pages.toggle-status', $page)); ?>" method="POST" class="inline">
                    <?php echo csrf_field(); ?>
                ...
                <form action="<?php echo e(route('admin.seo-pages.destroy', $page)); ?>"
                      method="POST"
                      class="inline"
    ...
    <tr>
        <td colspan="6" class="px-6 py-16 text-center">
            <div class="flex flex-col items-center gap-3">
                ...
                <a href="<?php echo e(route('admin.seo-pages.create')); ?>" class="mt-2 text-sm font-medium text-indigo-600 hover:text-indigo-800 underline">
                    Create a new page
                </a>
            </div>
        </td>
    </tr>
<?php endif; ?><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views\admin\seo_pages\partials\pages-table.blade.php ENDPATH**/ ?>