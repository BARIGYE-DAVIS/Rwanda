...
<div class="mb-6">
    <h4 class="text-sm font-semibold text-gray-700 mb-3">Current <?php echo e($sectionLabel); ?> Images</h4>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <?php $__currentLoopData = $existingImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $imageData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            ...
            <div class="border border-gray-200 rounded-lg p-3 bg-gray-50">
                ...
                <div class="text-xs space-y-1">
                    ...
                    <p class="text-gray-600">
                        <strong>Caption:</strong> <?php echo e($caption); ?>
...
<div class="border-2 border-dashed border-gray-300 rounded-lg p-6 bg-gray-50">
    <h4 class="text-sm font-semibold text-gray-700 mb-4">
        ...
        Add New <?php echo e($sectionLabel); ?> Images
    </h4>
    
    <div id="<?php echo e($sectionName); ?>-upload-container">
        <!-- Initial Upload Form -->
        <div class="section-image-item mb-4 p-4 bg-white rounded border border-gray-200">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                ...
                <div>
                    ...
                    <input type="text" 
                           name="<?php echo e($sectionName); ?>_sections[]" 
            ...
            <div>
                ...
                <input type="text" 
                       name="<?php echo e($sectionName); ?>_captions[]" 
    ...
    <button type="button" 
            ...
            data-section="<?php echo e($sectionName); ?>">
        <i class="fas fa-plus mr-2"></i>Add Another <?php echo e($sectionLabel); ?> Image
    </button>
</div>

<!-- Hidden field to track deleted section images -->
<input type="hidden" name="delete_<?php echo e($sectionName); ?>" id="delete_<?php echo e($sectionName); ?>" value=""><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views\admin\destinations\partials\section-images.blade.php ENDPATH**/ ?>