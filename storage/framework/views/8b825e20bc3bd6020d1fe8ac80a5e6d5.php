...
<?php $__env->startSection('title', 'Refund Policy | Rwanda Buget Safaris'); ?>
<?php $__env->startSection('meta_description', 'Understand the refund and cancellation policy for Rwanda Buget Safaris. Clear information on deposits, cancellation windows, and refund procedures.'); ?>
...
<header class="relative bg-gradient-to-r from-amber-600 to-orange-500 py-16 md:py-24">
    ...
    <div class="relative z-10 container mx-auto px-4 text-center text-white">
        ...
        <p class="text-sm text-amber-200 mt-4">Last updated: <?php echo e(date('F d, Y')); ?></p>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 mb-6">
            <p class="text-gray-700 leading-relaxed text-lg">
                At Rwanda Buget Safaris, we understand that plans can change. This Refund Policy sets out clearly what
        ...
        <div id="our-cancellation" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 mb-6 scroll-mt-24">
            <div class="flex items-start gap-4 mb-5">
                ...
                <h2 class="text-2xl font-bold text-gray-900 pt-1">Cancellation by Rwanda Buget Safaris</h2>
            </div>
        ...
        <div id="contact" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 mb-6 scroll-mt-24">
            ...
            <div class="bg-amber-50 rounded-xl p-6 space-y-3 text-gray-700">
                <div class="flex items-center gap-3"><span class="text-amber-600 font-bold"><i class="fas fa-map-marker-alt"></i></span><span><strong>Rwanda Buget Safaris</strong> <span class="text-amber-600">—</span> Kansanga, Kampala, Uganda</span></div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views\pages\refund-policy.blade.php ENDPATH**/ ?>