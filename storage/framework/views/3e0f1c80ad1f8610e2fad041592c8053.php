...
<?php $__env->startSection('title', 'Create SEO Page'); ?>
...
<div class="max-w-7xl mx-auto px-4 py-6 pb-28">
    ...
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Create SEO Page</h1>
    ...
    <form action="<?php echo e(route('admin.seo-pages.store')); ?>"
          method="POST"
                    ...
                    <div class="p-5 space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="meta_description" rows="2" maxlength="320"
                                      ...
                                      class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"><?php echo e(old('meta_description')); ?></textarea>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Focus Keyword</label>
                            <input type="text" name="focus_keyword"
                                   value="<?php echo e(old('focus_keyword')); ?>"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views\admin\seo_pages\create.blade.php ENDPATH**/ ?>