...
<div class="cover">
    ...
    <div class="cover-date">Comprehensive travel guide · Updated <?php echo e(date('Y')); ?></div>
</div>
...
<table class="toc-table">
    ...
    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$n,$t]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
        <td class="toc-num"><?php echo e($n); ?></td>
        <td class="toc-link"><?php echo e($t); ?></td>
    </tr>
...
<table class="data-table">
    ...
    <tr><td class="label-col"><?php echo e($k); ?></td><td><?php echo e($v); ?></td></tr>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</table>
...
<table class="info-row">
    ...
    <tr><td class="key"><?php echo e($k); ?></td><td><?php echo e($v); ?></td></tr>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</table>
...
<ol class="steps">
    ...
    <li>
        <div class="step-num"><div class="step-circle"><?php echo e($loop->index + 1); ?></div></div>
        <div class="step-body"><strong><?php echo e($t); ?>:</strong> <?php echo e($d); ?></div>
    </li>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</ol>
...
<table class="data-table">
    ...
    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$v,$badge,$s,$n]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
        <td class="label-col"><?php echo $v; ?></td>
        <td><span class="badge <?php echo e($badge); ?>"><?php echo e($s); ?></span></td>
        <td><?php echo e($n); ?></td>
    </tr>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</table>
...
<table class="month-table">
    ...
    <tr>
        <td><strong><?php echo e($m); ?></strong></td>
        <td><?php echo e($w); ?></td><td><?php echo e($wl); ?></td><td><?php echo e($cr); ?></td>
        <td class="stars"><?php echo e($r); ?></td>
    </tr>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</table>
        ...
        <td>
            <div class="col-box col-blue">
                ...
                <table style="width:100%; font-size:8pt; border-collapse:collapse;">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$r,$a]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr style="border-bottom:0.3pt solid #dbeafe;">
                        <td style="padding:1.5mm 0;"><?php echo e($r); ?></td>
                        <td style="padding:1.5mm 0; text-align:right; font-weight:bold; color:#166534;"><?php echo e($a); ?></td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </table>
            </div>
...
]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$heading, $items]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<table class="data-table">
    ...
    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$s,$n]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr><td class="label-col"><?php echo e($s); ?></td><td><strong><?php echo e($n); ?></strong></td></tr>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</table>
...
<table class="data-table">
    ...
    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$a,$t]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr><td class="label-col"><?php echo e($a); ?></td><td><?php echo e($t); ?></td></tr>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</table>
...
<table class="phrase-table">
    <?php $__currentLoopData = [['Hello','Oli otya'],['Good morning','Wasuze otya'],['Thank you','Webale nyo'],['You\'re welcome','Kale'],['Yes','Yee'],['No','Nedda'],['Please','Mwattu'],['How much?','Zamenga?'],['Welcome','Tukusanyukidde'],['Good','Bulungi']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$en,$lg]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <td><div class="phrase-en"><?php echo e($en); ?></div><div class="phrase-lg"><?php echo e($lg); ?></div></td>
    <?php if($loop->index % 5 === 4 && !$loop->last): ?> </tr><tr> <?php endif; ?>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</table>
...
<table class="region-table">
    ...
    <tr>
        <td class="label-col"><?php echo $r; ?></td>
        <td class="temp"><?php echo e($t); ?></td>
        <td><?php echo e($n); ?></td>
    </tr>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</table>
...
<div class="faq-item">
    <div class="faq-q">Q: <?php echo e($q); ?></div>
...
</html><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views\pages\tourist-information-pdf.blade.php ENDPATH**/ ?>