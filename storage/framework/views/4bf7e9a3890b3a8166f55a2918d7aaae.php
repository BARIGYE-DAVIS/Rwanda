...
<?php $__env->startSection('title', 'Budget Safaris & Affordable Tours – Best Value African Packages'); ?>

<?php $__env->startSection('meta_description', 'Discover budget safaris and affordable tour packages in East Africa. Explore Uganda, Kenya and Tanzania without breaking the bank. Real wildlife, real guides, real value.'); ?>

<?php $__env->startSection('meta_keywords', 'budget safaris, budget tours, affordable safari packages, cheap African safaris, budget East Africa tours, Uganda budget safari, Kenya budget safari, Tanzania budget safari, low cost safari packages'); ?>
                    ...
                    <?php $__currentLoopData = $tours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <article class="tour-card">
                            ...
                            <a href="<?php echo e($tourUrl); ?>" class="tour-card__img-wrap" tabindex="-1">
                                ...
                                <?php if($days): ?>
                                    <span class="tour-card__days"><?php echo e($days); ?> day<?php echo e($days != 1 ? 's' : ''); ?></span>
                                <?php endif; ?>
                            </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views\tours\budget-index.blade.php ENDPATH**/ ?>