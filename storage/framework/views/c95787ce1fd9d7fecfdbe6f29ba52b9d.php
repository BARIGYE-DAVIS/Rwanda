...
<?php $__env->startSection('title', 'Booking Requests - Admin Dashboard'); ?>
...
<div class="container-fluid px-4 py-6">
    ...
    <div class="mb-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="mt-4 sm:mt-0 flex space-x-3">
                <a href="<?php echo e(route('admin.contacts.export')); ?>" 
    ...
    <div class="bg-white shadow rounded-lg mb-6">
        ...
        <div class="px-6 py-4">
            <form method="GET" action="<?php echo e(route('admin.contacts.index')); ?>" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <!-- Search -->
                <div>
                ...
                <div>
                    ...
                    <select name="status" id="status" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500">
                        ...
                        <option value="quoted" <?php echo e(request('status') === 'quoted' ? 'selected' : ''); ?>>Quoted</option>
                ...
                <div>
                    ...
                    <select name="destination" id="destination" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500">
                        ...
                        <?php $__currentLoopData = $destinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($dest->destination); ?>" <?php echo e(request('destination') === $dest->destination ? 'selected' : ''); ?>>
                                <?php echo e($dest->destination); ?> (<?php echo e($dest->count); ?>)
                            </option>
                ...
                <div class="flex items-end space-x-2">
                    ...
                    <a href="<?php echo e(route('admin.contacts.index')); ?>" class="px-4 py-2 bg-gray-300 border border-transparent rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-400 transition ease-in-out duration-150">
    ...
    <div class="bg-white shadow overflow-hidden rounded-md">
        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            <h3 class="text-lg font-medium text-gray-900">
                Booking Requests 
                <?php if(request()->hasAny(['search', 'status', 'destination'])): ?>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 <?php echo e($contact->status === 'pending' ? 'bg-blue-50 border-l-4 border-blue-400' : ''); ?>">
                        <!-- Checkbox -->
                        <td class="px-6 py-4 whitespace-nowrap">
                            <input type="checkbox" name="selected_contacts[]" value="<?php echo e($contact->id); ?>" class="contact-checkbox rounded border-gray-300 text-green-600 shadow-sm focus:border-green-300 focus:ring focus:ring-green-200 focus:ring-opacity-50">
                        </td>
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10">
                                    <div class="h-10 w-10 rounded-full bg-<?php echo e($contact->status === 'pending' ? 'blue' : 'gray'); ?>-100 flex items-center justify-center">
                                        <i class="fas fa-user text-<?php echo e($contact->status === 'pending' ? 'blue' : 'gray'); ?>-600"></i>
                                    </div>
                                </div>
                                <div class="ml-4">
                                    <div class="text-sm font-medium text-gray-900"><?php echo e($contact->first_name); ?> <?php echo e($contact->last_name); ?></div>
                                    ...
                                    <div class="text-xs text-gray-500 mt-1">
                                        ...
                                        <span class="inline-flex items-center">
                                            ...
                                            <?php echo e($contact->nationality); ?>
                        ...
                        <td class="px-6 py-4">
                            <div class="text-sm text-gray-900">
                                <span class="font-medium">Destination:</span> <?php echo e($contact->destination ?? 'N/A'); ?>

                            </div>
                            <div class="text-sm text-gray-600">
                                <span class="font-medium">People:</span> <?php echo e($contact->number_of_people ?? 'N/A'); ?>

                                | <span class="font-medium">Days:</span> <?php echo e($contact->number_of_days ?? 'N/A'); ?>

                            </div>
                            <div class="text-xs text-gray-500 mt-1">
                                <span class="font-medium">Budget:</span> <?php echo e($contact->formatted_budget ?? 'N/A'); ?>

                                | <span class="font-medium">Accommodation:</span> <?php echo e($contact->accommodation_list ?? 'N/A'); ?>

                            </div>
                            <?php if($contact->preferred_travel_date): ?>
                            <div class="text-xs text-gray-500">
                                <i class="fas fa-calendar-alt mr-1"></i> <?php echo e($contact->preferred_travel_date); ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            <div><?php echo e($contact->created_at->format('M d, Y')); ?></div>
                            <div class="text-xs text-gray-400"><?php echo e($contact->created_at->format('H:i A')); ?></div>
                            <div class="text-xs text-gray-400"><?php echo e($contact->created_at->diffForHumans()); ?></div>
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex items-center space-x-2">
                                ...
                                <form action="<?php echo e(route('admin.contacts.destroy', $contact->id)); ?>" method="POST" class="inline-block" onsubmit="return confirm('Are you sure you want to delete this booking request?')">
                                    <?php echo csrf_field(); ?>
        ...
        <div class="text-center py-12">
            ...
            <?php if(request()->hasAny(['search', 'status', 'destination'])): ?>
            <div class="mt-6">
                <a href="<?php echo e(route('admin.contacts.index')); ?>" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700">
...
<!-- Bulk Action Form -->
<form id="bulkActionForm" action="<?php echo e(route('admin.contacts.bulk')); ?>" method="POST" style="display: none;">
    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views\admin\contacts\index.blade.php ENDPATH**/ ?>