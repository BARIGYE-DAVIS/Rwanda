...
<div class="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-44">
    ...
    <form method="POST"
          action="<?php echo e(route('admin.blogs.store')); ?>"
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1 space-y-5">
          ...
          <div class="bg-slate-800/60 backdrop-blur border border-slate-700 rounded-2xl p-6 ring-1 ring-white/5">
            ...
            <input type="text" name="author_name" value="<?php echo e(old('author_name')); ?>"
            ...
            <div class="space-y-4">
              ...
              <div>
                ...
                <textarea name="meta_description" id="meta-desc-input" maxlength="160" rows="3"
                          ...
                          class="w-full px-3 py-2.5 bg-slate-900 border border-slate-600 rounded-xl text-white text-sm
                                 placeholder-slate-600 focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition resize-none"><?php echo e(old('meta_description')); ?></textarea>
                <div class="mt-1.5 h-1 rounded-full bg-slate-700 overflow-hidden">
              ...
              <div class="mt-2 p-3 bg-white rounded-xl text-left">
                ...
                <p id="serp-title" class="text-blue-700 text-sm font-medium truncate leading-snug">
                  <?php echo e(old('meta_title', 'Your blog title will appear here')); ?>

                </p>
                <p class="text-green-700 text-xs truncate"><?php echo e(url('/blog/your-post-slug')); ?></p>
                <p id="serp-desc" class="text-slate-600 text-xs mt-0.5 leading-relaxed line-clamp-2">
                  <?php echo e(old('meta_description', 'Your meta description will appear here. Write something compelling to improve click-through rate.')); ?>
...
<script src="<?php echo e(asset('js/blog-create.js')); ?>"></script>
<script>
...
<script src="<?php echo e(asset('js/blog-import.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views\admin\blogs\create.blade.php ENDPATH**/ ?>