...
<?php $__env->startSection('title', 'Tour Request Details - ' . $customTourRequest->reference_number); ?>
        ...
        <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
            <div class="flex-1">
                <div class="flex items-center gap-3 mb-3">
                    ...
                    <div>
                        <h1 class="text-2xl md:text-3xl font-bold text-gray-800"><?php echo e($customTourRequest->reference_number); ?></h1>
                        <div class="flex items-center gap-2 mt-2">
                            <span class="px-3 py-1 rounded-full text-sm font-medium <?php echo e($customTourRequest->status_class); ?>">
                                <i class="fas <?php echo e($customTourRequest->status_icon); ?> mr-1"></i>
                                <?php echo e($customTourRequest->status_label); ?>

                            </span>
                            <?php if($customTourRequest->isUrgent()): ?>
                ...
                <div class="flex items-center gap-3 text-gray-600">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-sm">Submitted <?php echo e($customTourRequest->created_at->format('F j, Y \a\t g:i A')); ?></span>
                    </div>
                    <span class="text-gray-300">•</span>
                    <div class="flex items-center gap-2">
                        <i class="fas fa-clock text-gray-400"></i>
                        <span class="text-sm"><?php echo e($customTourRequest->created_at->diffForHumans()); ?></span>
                    </div>
                </div>
            </div>
            <div class="flex items-center gap-3">
                <a href="<?php echo e(route('admin.custom-tour-requests.edit', $customTourRequest)); ?>" 
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-gray-50 rounded-lg p-4">
                            ...
                            <div class="flex items-center gap-2">
                                <?php if($customTourRequest->phone): ?>
                                <a href="tel:<?php echo e($customTourRequest->phone); ?>" 
                                   class="text-gray-800 font-medium text-lg inline-flex items-center gap-1 hover:text-green-600">
                                    <i class="fas fa-phone text-sm"></i>
                                    <?php echo e($customTourRequest->phone); ?>
                        ...
                        <div class="bg-gray-50 rounded-lg p-4">
                            ...
                            <p class="text-gray-800 font-medium text-lg"><?php echo e($customTourRequest->country ?? 'Not specified'); ?></p>
                        </div>
                        <?php if($customTourRequest->language): ?>
                        <div class="bg-gray-50 rounded-lg p-4">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-gray-800 font-medium"><?php echo e($customTourRequest->language); ?></span>
                            </div>
                        </div>
                        <?php endif; ?>
                        <?php if($customTourRequest->heard_from): ?>
                        <div class="bg-gray-50 rounded-lg p-4">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-gray-800 font-medium"><?php echo e($customTourRequest->heard_from); ?></span>
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div class="bg-blue-50 rounded-lg p-4">
                            ...
                            <?php if($customTourRequest->travel_date_from): ?>
                            <div class="flex items-center gap-2">
                                <i class="fas fa-calendar text-blue-500"></i>
                                <span class="text-gray-800 font-medium"><?php echo e($customTourRequest->travel_dates_formatted); ?></span>
                        ...
                        <div class="bg-blue-50 rounded-lg p-4">
                            ...
                            <?php if($customTourRequest->duration): ?>
                            <div class="flex items-center gap-2">
                                <i class="fas fa-clock text-blue-500"></i>
                                <span class="text-gray-800 font-medium"><?php echo e($customTourRequest->duration); ?></span>
                            </div>
                            <?php else: ?>
                            <p class="text-gray-400">Not specified</p>
                            <?php endif; ?>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="bg-white border border-gray-200 rounded-lg p-4 text-center hover:shadow-md transition-shadow duration-200">
                                ...
                                <p class="text-2xl font-bold text-gray-800"><?php echo e($customTourRequest->adults_count); ?></p>
                            ...
                            <div class="bg-white border border-gray-200 rounded-lg p-4 text-center hover:shadow-md transition-shadow duration-200">
                                ...
                                <p class="text-2xl font-bold text-gray-800"><?php echo e($customTourRequest->children_count); ?></p>
                            ...
                            <div class="bg-white border border-gray-200 rounded-lg p-4 text-center hover:shadow-md transition-shadow duration-200">
                                ...
                                <p class="text-2xl font-bold text-gray-800"><?php echo e($customTourRequest->infants_count); ?></p>
                        ...
                        <div class="mt-4 pt-4 border-t border-gray-100">
                            <div class="text-center">
                                <span class="px-4 py-2 bg-gradient-to-r from-indigo-500 to-indigo-600 text-white rounded-lg font-medium">
                                    Total: <?php echo e($customTourRequest->total_travelers); ?> Travelers
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <?php if($customTourRequest->destinations_details && $customTourRequest->destinations_details->count() > 0): ?>
                                <div class="space-y-2">
                                    <?php $__currentLoopData = $customTourRequest->destinations_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $destination): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center gap-3 p-3 bg-gradient-to-r from-indigo-50 to-indigo-100 rounded-lg hover:from-indigo-100 hover:to-indigo-200 transition-all duration-200">
                                        ...
                                        <div>
                                            <p class="font-medium text-gray-800"><?php echo e($destination->name); ?></p>
                                            <?php if($destination->country): ?>
                                            <p class="text-xs text-gray-500"><?php echo e($destination->country->name ?? ''); ?></p>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                        ...
                        <div>
                            ...
                            <?php if($customTourRequest->activities_details && $customTourRequest->activities_details->count() > 0): ?>
                                <div class="space-y-2">
                                    <?php $__currentLoopData = $customTourRequest->activities_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center gap-3 p-3 bg-gradient-to-r from-green-50 to-emerald-100 rounded-lg hover:from-green-100 hover:to-emerald-200 transition-all duration-200">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-gray-500"><?php echo e($activity->category->name ?? ''); ?></p>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div class="bg-yellow-50 rounded-lg p-4">
                                ...
                                <p class="text-gray-800 font-medium"><?php echo e($customTourRequest->budget_category ?? 'Not specified'); ?></p>
                            </div>
                            <div class="bg-yellow-50 rounded-lg p-4">
                                <label class="text-xs font-medium text-yellow-600 uppercase tracking-wider mb-1">Approximate Budget</label>
                                <p class="text-gray-800 font-medium"><?php echo e($customTourRequest->approximate_budget ?? 'Not specified'); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            <div class="bg-gray-50 rounded-lg p-4 mb-4">
                                ...
                                <p class="text-gray-800 font-medium"><?php echo e($customTourRequest->accommodation_preference ?? 'Not specified'); ?></p>
                            </div>
                        </div>

                        <!-- Special Requirements -->
                        <?php if($customTourRequest->special_requirements && count($customTourRequest->special_requirements) > 0): ?>
                        <div class="md:col-span-2">
                            <label class="text-sm font-medium text-gray-700 mb-3 block">Special Requirements</label>
                            <div class="flex flex-wrap gap-2">
                                <?php $__currentLoopData = $customTourRequest->special_requirements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $requirement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="px-3 py-2 bg-gradient-to-r from-orange-100 to-orange-200 text-orange-800 rounded-lg text-sm font-medium">
                                    <i class="fas fa-star mr-1"></i><?php echo e($requirement); ?>
                        ...
                        <?php if($customTourRequest->dietary_restrictions): ?>
                        <div class="bg-green-50 rounded-lg p-4">
                            ...
                            <div class="flex items-start gap-2">
                                ...
                                <p class="text-gray-800"><?php echo e($customTourRequest->dietary_restrictions); ?></p>
                            </div>
                        </div>
                        <?php endif; ?>

                        <!-- Medical Conditions -->
                        <?php if($customTourRequest->medical_conditions): ?>
                        <div class="bg-red-50 rounded-lg p-4">
                            ...
                            <div class="flex items-start gap-2">
                                ...
                                <p class="text-gray-800"><?php echo e($customTourRequest->medical_conditions); ?></p>
                            </div>
                        </div>
                        <?php endif; ?>

                        <!-- Special Requests -->
                        <?php if($customTourRequest->special_requests): ?>
                        <div class="md:col-span-2">
                            <div class="bg-blue-50 rounded-lg p-4">
                                ...
                                <div class="flex items-start gap-2">
                                    ...
                                    <p class="text-gray-800"><?php echo e($customTourRequest->special_requests); ?></p>
                                </div>
                            </div>
                        </div>
                        <?php endif; ?>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden sticky top-6">
                ...
                <div class="p-6">
                    <!-- Status Update -->
                    <form method="POST" action="<?php echo e(route('admin.custom-tour-requests.update-status', $customTourRequest)); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="flex gap-2 mb-4">
                            <select name="status" 
                                ...
                                <?php $__currentLoopData = $statuses ?? \App\Models\CustomTourRequest::getStatuses(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($value); ?>" <?php echo e($customTourRequest->status == $value ? 'selected' : ''); ?>>
                                    <?php echo e($label); ?>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="p-6">
                    <?php if($customTourRequest->admin_notes): ?>
                        <div class="mb-4">
                            ...
                            <div class="bg-gray-50 rounded-lg p-4 max-h-48 overflow-y-auto">
                                <?php if(isset($formattedAdminNotes) && count($formattedAdminNotes) > 0): ?>
                                    <div class="space-y-3">
                                        <?php $__currentLoopData = $formattedAdminNotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="pb-3 border-b border-gray-100 last:border-0 last:pb-0">
                                            <div class="flex items-center justify-between mb-1">
                                                <span class="text-xs text-gray-500"><?php echo e($note['date']); ?> at <?php echo e($note['time']); ?></span>
                                                <?php if($note['is_urgent']): ?>
                                                <span class="px-2 py-0.5 bg-red-100 text-red-800 text-xs rounded">New</span>
                                                <?php endif; ?>
                                            </div>
                                            <p class="text-gray-700 text-sm"><?php echo e($note['note']); ?></p>
                                        </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                <?php else: ?>
                                    <pre class="text-sm text-gray-600 whitespace-pre-wrap"><?php echo e($customTourRequest->admin_notes); ?></pre>
                                <?php endif; ?>
                            </div>
                        </div>
                    <?php else: ?>
                    ...
                    <!-- Add Note Form -->
                    <form method="POST" action="<?php echo e(route('admin.custom-tour-requests.add-note', $customTourRequest)); ?>">
                        <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <p class="text-xs text-gray-500"><?php echo e($customTourRequest->created_at->format('h:i A')); ?></p>
                            </div>
                            <div>
                                ...
                                <p class="text-xs text-gray-500"><?php echo e($customTourRequest->updated_at->format('h:i A')); ?></p>
                            </div>
                        </div>
                        <div class="pt-4 border-t border-gray-100">
                            <label class="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Age</label>
                            <p class="text-sm text-gray-600"><?php echo e($customTourRequest->created_at->diffForHumans()); ?></p>
                        </div>
                        <?php if($customTourRequest->destinations_count > 0 || $customTourRequest->activities_count > 0): ?>
                        <div class="pt-4 border-t border-gray-100">
                            <label class="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Selections</label>
                            <div class="grid grid-cols-2 gap-3">
                                <div class="text-center">
                                    <div class="text-lg font-bold text-indigo-600"><?php echo e($customTourRequest->destinations_count); ?></div>
                                    <div class="text-xs text-gray-500">Destinations</div>
                                </div>
                                <div class="text-center">
                                    <div class="text-lg font-bold text-green-600"><?php echo e($customTourRequest->activities_count); ?></div>
    ...
    <div class="relative top-20 mx-auto p-5 border w-full max-w-md shadow-lg rounded-xl bg-white">
        <div class="mt-3">
                ...
                <div class="bg-gray-50 rounded-lg p-4 mb-4">
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <p class="font-medium"><?php echo e($customTourRequest->reference_number); ?></p>
                        </div>
                        <div>
                            <label class="text-xs font-medium text-gray-500">Customer</label>
                            <p class="font-medium"><?php echo e($customTourRequest->name); ?></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex items-center gap-3 px-4 py-3">
                ...
                <form method="POST" action="<?php echo e(route('admin.custom-tour-requests.destroy', $customTourRequest)); ?>" class="flex-1">
                    <?php echo csrf_field(); ?>
...
<script>
    ...
    function copyReference() {
        const reference = "<?php echo e($customTourRequest->reference_number); ?>";
    ...
    document.querySelector('select[name="status"]')?.addEventListener('change', function(e) {
        if (this.value === 'cancelled') {
            if (!confirm('Are you sure you want to mark this request as cancelled?')) {
                this.value = "<?php echo e($customTourRequest->status); ?>";
            }
        }
    });
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views\admin\custom-tour-requests\show.blade.php ENDPATH**/ ?>