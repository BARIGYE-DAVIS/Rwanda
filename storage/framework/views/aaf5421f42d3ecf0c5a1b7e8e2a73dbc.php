...
<?php $__env->startSection('title', 'Gallery Management - Admin Dashboard'); ?>
...
<div class="container-fluid px-4 py-6">
    ...
    <div class="mb-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="mt-4 sm:mt-0 flex space-x-3">
                ...
                <a href="<?php echo e(route('admin.gallery.export')); ?>" 
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900"><?php echo e(number_format($stats['visible'])); ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900"><?php echo e(number_format($stats['hidden'])); ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900"><?php echo e(number_format($stats['recent'])); ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-white shadow rounded-lg mb-6">
        ...
        <div class="px-6 py-4">
            <form method="GET" action="<?php echo e(route('admin.gallery.index')); ?>" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <!-- Search -->
                <div>
                ...
                <div>
                    ...
                    <select name="is_visible" id="is_visible" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500">
                        ...
                        <option value="1" <?php echo e(request('is_visible') === '1' ? 'selected' : ''); ?>>Visible</option>
                        <option value="0" <?php echo e(request('is_visible') === '0' ? 'selected' : ''); ?>>Hidden</option>
                    </select>
                </div>
                ...
                <div class="flex items-end space-x-2">
                    ...
                    <a href="<?php echo e(route('admin.gallery.index')); ?>" class="px-4 py-2 bg-gray-300 border border-transparent rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-400 transition ease-in-out duration-150">
                        Clear
                    </a>
                </div>
            </form>
    ...
    <div class="bg-white shadow overflow-hidden rounded-md">
        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            <h3 class="text-lg font-medium text-gray-900">
                Gallery Images
                <?php if(request()->hasAny(['search', 'category', 'is_visible'])): ?>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                ...
                <div class="relative group bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-200">
                    ...
                    <div class="absolute top-2 left-2 z-10">
                        <input type="checkbox" name="selected_images[]" value="<?php echo e($image->id); ?>" class="image-checkbox rounded border-gray-300 text-red-600 shadow-sm focus:border-red-300 focus:ring focus:ring-red-200 focus:ring-opacity-50">
                    </div>

                    <!-- Visibility Toggle -->
                    <div class="absolute top-2 right-2 z-10">
                        <button type="button" 
                                class="visibility-toggle w-8 h-8 rounded-full <?php echo e($image->is_visible ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600'); ?> flex items-center justify-center hover:shadow-md transition-all"
                                data-id="<?php echo e($image->id); ?>"
                                data-visible="<?php echo e($image->is_visible); ?>"
                                title="<?php echo e($image->is_visible ? 'Hide from public' : 'Show to public'); ?>">
                            <?php if($image->is_visible): ?>
                    ...
                    <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-50 transition-all duration-200 flex items-center justify-center opacity-0 group-hover:opacity-100">
                        <div class="flex space-x-2">
                            <a href="<?php echo e(route('admin.gallery.edit', $image)); ?>"
                            ...
                            <a href="<?php echo e(route('admin.gallery.show', $image->slug)); ?>" 
                               target="_blank"
                            ...
                            <form action="<?php echo e(route('admin.gallery.destroy', $image->id)); ?>" method="POST" class="inline-block" onsubmit="return confirm('Are you sure you want to delete this image?')">
                                <?php echo csrf_field(); ?>
                    ...
                    <!-- Image Info -->
                    <div class="p-4">
                        <h4 class="font-medium text-gray-900 truncate" title="<?php echo e($image->title); ?>"><?php echo e($image->title); ?></h4>
                        <p class="text-sm text-gray-500 truncate mt-1"><?php echo e($image->category_label); ?></p>
                        <p class="text-xs text-gray-400 mt-2"><?php echo e($image->created_at->format('M d, Y')); ?></p>
                        
                        <!-- Tags -->
                        <?php if($image->formatted_tags): ?>
                        <div class="flex flex-wrap gap-1 mt-2">
                            <?php $__currentLoopData = array_slice($image->formatted_tags, 0, 2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="inline-block bg-gray-100 text-gray-600 text-xs px-2 py-1 rounded"><?php echo e($tag); ?></span>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php if(count($image->formatted_tags) > 2): ?>
                            <span class="text-xs text-gray-400">+<?php echo e(count($image->formatted_tags) - 2); ?> more</span>
                            <?php endif; ?>
                        </div>
                        <?php endif; ?>
        ...
        <div class="text-center py-12">
            ...
            <div class="mt-6">
                <?php if(request()->hasAny(['search', 'category', 'is_visible'])): ?>
                    <a href="<?php echo e(route('admin.gallery.index')); ?>" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700">
                        Clear Filters
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('admin.gallery.create')); ?>" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                        </svg>
                        Add First Image
...
<!-- Bulk Delete Form -->
<form id="bulkDeleteForm" action="<?php echo e(route('admin.gallery.bulk-delete')); ?>" method="POST" style="display: none;">
    <?php echo csrf_field(); ?>
    <?php echo method_field('DELETE'); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views\admin\gallery\index.blade.php ENDPATH**/ ?>