...
<?php $__env->startSection('title', 'Privacy Policy | Rwanda Buget Safaris'); ?>
<?php $__env->startSection('meta_description', 'Read our Privacy Policy to understand how Rwanda Buget Safaris collects, uses, and protects your personal information.'); ?>
...
<header class="relative bg-gradient-to-r from-green-700 to-teal-600 py-16 md:py-24">
    ...
    <div class="relative z-10 container mx-auto px-4 text-center text-white">
        ...
        <p class="text-sm text-green-300 mt-4">Last updated: <?php echo e(date('F d, Y')); ?></p>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
                <?php $__currentLoopData = [
                    ...
                    <a href="<?php echo e($anchor); ?>" class="text-green-600 hover:text-green-800 hover:underline transition-colors py-1"><?php echo e($label); ?></a>
        ...
        <div id="<?php echo e($section['id']); ?>" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 mb-6 scroll-mt-24">
            <div class="flex items-start gap-4 mb-5">
                <span class="text-4xl font-black text-green-100 leading-none select-none"><?php echo e($section['number']); ?></span>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views\pages\privacy-policy.blade.php ENDPATH**/ ?>