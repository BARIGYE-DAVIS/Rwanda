      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td>
            ...
            <div style="font-family:'Courier New',monospace;color:#c9a84c;font-size:20px;font-weight:700;letter-spacing:2px;"><?php echo e($tourRequest->reference_number); ?></div>
          </td>
          <td align="right" valign="middle" style="white-space:nowrap;padding-left:16px;">
            <div style="background:rgba(255,255,255,0.08);border:1px solid rgba(201,168,76,0.3);border-radius:8px;padding:10px 16px;text-align:center;">
              ...
              <div style="font-size:13px;font-weight:700;color:#fff;"><?php echo e(\Carbon\Carbon::parse($tourRequest->created_at)->format('M j, Y · g:i A')); ?></div>
            </div>
          </td>
        </tr>
      </table>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid #e2e8f0;border-radius:12px;overflow:hidden;">
      <tr style="background:#f8fafc;">
        <td colspan="2" style="padding:14px 18px;border-bottom:1px solid #e2e8f0;">
          ...
          <div style="font-size:18px;color:#0a1628;font-weight:700;"><?php echo e($tourRequest->name); ?></div>
        </td>
      </tr>
      <tr>
        <td width="50%" style="padding:12px 18px;border-bottom:1px solid #e2e8f0;border-right:1px solid #e2e8f0;">
          ...
          <a href="mailto:<?php echo e($tourRequest->email); ?>" style="font-size:14px;color:#1a5c35;font-weight:600;text-decoration:none;"><?php echo e($tourRequest->email); ?></a>
        </td>
        <td width="50%" style="padding:12px 18px;border-bottom:1px solid #e2e8f0;">
          ...
          <?php if($tourRequest->phone): ?>
            <a href="tel:<?php echo e($tourRequest->phone); ?>" style="font-size:14px;color:#1a5c35;font-weight:600;text-decoration:none;"><?php echo e($tourRequest->phone); ?></a>
          <?php else: ?>
      ...
      <tr>
        ...
        <td width="50%" style="padding:12px 18px;">
          ...
          <div style="font-size:14px;color:#1e293b;font-weight:600;"><?php echo e($tourRequest->heard_from ?? 'Not specified'); ?></div>
        </td>
      </tr>
    </table>
  </td></tr>
  ...
  <tr><td style="background:#fff;padding:0 48px 28px;">
    ...
    <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:12px;padding:18px 20px;">
      ...
      <div style="display:inline-block;background:#0d2d1f;color:#4ade80;font-size:12px;font-weight:600;padding:6px 14px;border-radius:20px;margin:4px 4px 4px 0;">
        🗺️ <?php echo e($destination->name); ?><?php if($destination->country): ?> — <?php echo e($destination->country->name); ?><?php endif; ?>
      </div>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr>
        <td align="center" style="padding-right:6px;">
          <a href="mailto:<?php echo e($tourRequest->email); ?>" style="display:block;background:linear-gradient(135deg,#1a5c35,#0f3d22);color:#fff;font-size:13px;font-weight:700;letter-spacing:1px;text-decoration:none;padding:13px 8px;border-radius:10px;text-align:center;">📧 Email Client</a>
        </td>
        <?php if($tourRequest->phone): ?>
        <td align="center" style="padding:0 6px;">
          <a href="tel:<?php echo e($tourRequest->phone); ?>" style="display:block;background:linear-gradient(135deg,#0d2d1f,#1a3a2a);color:#fff;font-size:13px;font-weight:700;letter-spacing:1px;text-decoration:none;padding:13px 8px;border-radius:10px;text-align:center;">📞 Call Client</a>
        </td>
        <?php endif; ?>
        <td align="center" style="padding-left:6px;">
          <a href="<?php echo e(config('app.url')); ?>/admin/custom-tour-requests/<?php echo e($tourRequest->id); ?>" style="display:block;background:linear-gradient(135deg,#c9a84c,#a8863d);color:#0a1628;font-size:13px;font-weight:700;letter-spacing:1px;text-decoration:none;padding:13px 8px;border-radius:10px;text-align:center;">🔎 Open Request</a>
        </td>
      </tr>
    </table>
  </td></tr>
  ...
  <tr><td style="background:#fff;padding:0 48px 44px;">
    <div style="background:linear-gradient(135deg,#0a1628,#0d2d1f);border-radius:14px;padding:28px;">
      ...
      <p style="margin:0;color:rgba(255,255,255,0.65);font-size:14px;line-height:1.8;">
        Please send <strong style="color:#4ade80;"><?php echo e($tourRequest->name); ?></strong> a personalised itinerary and quote. They submitted their request on <strong style="color:#c9a84c;"><?php echo e(\Carbon\Carbon::parse($tourRequest->created_at)->format('F j, Y \a\t g:i A')); ?></strong>.
      </p>
    </div>
  </td></tr>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr><td align="center" style="padding:24px 40px;">
        <p style="margin:0 0 4px;font-size:11px;color:rgba(255,255,255,0.3);letter-spacing:2px;text-transform:uppercase;">
          Ref: <?php echo e($tourRequest->reference_number); ?> &nbsp;·&nbsp; <?php echo e(\Carbon\Carbon::parse($tourRequest->created_at)->format('F j, Y g:i A')); ?>
...
</html><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views\emails\custom-tour-notification.blade.php ENDPATH**/ ?>