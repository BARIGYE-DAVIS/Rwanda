...
<?php $__env->startSection('title', 'Edit SEO Page'); ?>
...
<div class="max-w-7xl mx-auto px-4 py-6 pb-28">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="<?php echo e(route('admin.seo-pages.index')); ?>"
    ...
    <form action="<?php echo e(route('admin.seo-pages.update', $seoPage)); ?>"
          method="POST"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="p-5 space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text"
                                   name="title"
                                   id="title-input"
                                   value="<?php echo e(old('title', $seoPage->title)); ?>"
                        ...
                        <div>
                            ...
                            <div class="flex rounded-lg border border-gray-300 overflow-hidden focus-within:ring-2 focus-within:ring-blue-500">
                                ...
                                <input type="text"
                                       name="slug"
                                       id="slug-input"
                                       value="<?php echo e(old('slug', $seoPage->slug)); ?>"
                        ...
                        <div>
                            ...
                            <textarea name="meta_description"
                                      rows="2"
                                      maxlength="320"
                                      class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"><?php echo e(old('meta_description', $seoPage->meta_description)); ?></textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text"
                                   name="focus_keyword"
                                   value="<?php echo e(old('focus_keyword', $seoPage->focus_keyword)); ?>"
                                   class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                    ...
                    <div class="p-5">
                        <div id="blocks-container">
                            <?php $sortedBlocks = $seoPage->blocks->sortBy('sort_order')->values(); ?>

                            <?php if($sortedBlocks->count() === 0): ?>
                            ...
                            <?php else: ?>
                                <?php $__currentLoopData = $sortedBlocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $block): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="block-item border border-gray-200 rounded-xl p-4 mb-3 bg-gray-50"
                                         data-block-id="<?php echo e($block->id); ?>"
                                         data-block-index="<?php echo e($loop->index); ?>"
                                         data-index="<?php echo e($loop->index); ?>">
                                        <input type="hidden" name="blocks[<?php echo e($loop->index); ?>][id]" value="<?php echo e($block->id); ?>">
                                        <input type="hidden" name="blocks[<?php echo e($loop->index); ?>][type]" value="<?php echo e($block->block_type); ?>">
                                        ...
                                        <?php if($block->block_type === 'heading'): ?>
                                            ...
                                            <div class="flex gap-3 mb-3">
                                                <div class="w-36">
                                                    ...
                                                    <select name="blocks[<?php echo e($loop->index); ?>][heading_level]" onchange="updateHeadingPreview(this)"
                                                        ...
                                                        <?php $__currentLoopData = ['h1','h2','h3','h4','h5','h6']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($hl); ?>" <?php echo e($block->heading_level === $hl ? 'selected' : ''); ?>>
                                                                <?php echo e(strtoupper($hl)); ?> — <?php echo e($hl === 'h1' ? 'Page Title' : ($hl === 'h2' ? 'Section' : ($hl === 'h3' ? 'Sub-section' : ''))); ?>
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <input type="text" name="blocks[<?php echo e($loop->index); ?>][content]"
                                        ...
                                        <?php elseif($block->block_type === 'text'): ?>
                                            ...
                                            <div contenteditable="true"
                                                 ...
                                                 oninput="syncParagraph(this, <?php echo e($loop->index); ?>)"><?php echo $block->content; ?></div>
                                            <input type="hidden" name="blocks[<?php echo e($loop->index); ?>][content]" id="para-content-<?php echo e($loop->index); ?>" value="<?php echo e($block->content); ?>">
                                        ...
                                        <?php elseif($block->block_type === 'list'): ?>
                                            ...
                                            <div class="flex gap-3 mb-3">
                                                <div class="w-36">
                                                    ...
                                                    <select name="blocks[<?php echo e($loop->index); ?>][list_type]" 
                                                            class="w-full border border-gray-300 rounded-lg px-2 py-1.5 text-sm">
                                            ...
                                            <div contenteditable="true"
                                                 ...
                                                 onkeyup="saveSelection()"
                                                 onmouseup="saveSelection()"
                                                 oninput="syncList(this, <?php echo e($loop->index); ?>)"
                                                 placeholder="• Item 1&#10;• Item 2&#10;• Item 3"><?php echo $block->content; ?></div>
                                            <input type="hidden" name="blocks[<?php echo e($loop->index); ?>][content]" id="list-content-<?php echo e($loop->index); ?>" value="<?php echo e($block->content); ?>">

                                        
                                        <?php elseif($block->block_type === 'image'): ?>
                                            <div class="flex items-center justify-between mb-3">
                                                <span class="text-xs font-semibold uppercase tracking-wide text-gray-500">
                                                    Images <span id="img-count-<?php echo e($loop->index); ?>" class="text-blue-500"></span>
                                                </span>
                                                <button type="button" onclick="removeBlock(this)" class="text-xs text-red-500 hover:text-red-700">Remove</button>
                                            </div>

                                            
                                            <?php if($block->images->count() > 0): ?>
                                                <div class="mb-3">
                                                    ...
                                                    <div class="grid grid-cols-3 gap-2">
                                                        <?php $__currentLoopData = $block->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div class="relative rounded-lg overflow-hidden border border-gray-200 bg-white group existing-image-item"
                                                                ...
                                                                <input type="hidden" name="blocks[<?php echo e($loop->parent->index); ?>][existing_images][<?php echo e($image->id); ?>]" value="<?php echo e($image->id); ?>">
                                                                <input type="hidden" name="blocks[<?php echo e($loop->parent->index); ?>][delete_images][]" class="delete-image-flag" value="">
                                                                <button type="button"
                                                                        ...
                                                                        onclick="deleteExistingImage(this, <?php echo e($loop->parent->index); ?>, <?php echo e($image->id); ?>)">&times;</button>
                                                                <input type="text"
                                                                       name="blocks[<?php echo e($loop->parent->index); ?>][alts][<?php echo e($image->id); ?>]"
                                            ...
                                            <div id="img-preview-<?php echo e($loop->index); ?>" class="grid grid-cols-3 gap-2 mb-3"></div>
                                            <div id="img-transfer-<?php echo e($loop->index); ?>"></div>
                                            <label class="block w-full border-2 border-dashed border-gray-300 rounded-xl p-5 text-center cursor-pointer hover:border-blue-400 hover:bg-blue-50 transition">
                                                <input type="file" class="hidden" accept="image/jpeg,image/png,image/webp" multiple
                                                       onchange="accumulateImages(this, <?php echo e($loop->index); ?>)">
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <input type="text" name="blocks[<?php echo e($loop->index); ?>][alts][]"
                                                       class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm"
                                                       placeholder="Describe these images for SEO">
                                            </div>

                                            <script>if (!window.blockFiles) window.blockFiles = {}; window.blockFiles[<?php echo e($loop->index); ?>] = window.blockFiles[<?php echo e($loop->index); ?>] || [];</script>
                                        ...
                                        <?php elseif($block->block_type === 'links'): ?>
                                            <div class="flex items-center justify-between mb-3">
                                                ...
                                                <div class="flex gap-3">
                                                    <button type="button" onclick="openLinkModal(<?php echo e($loop->index); ?>)" class="text-xs text-blue-600 hover:text-blue-800 font-medium">+ Add Link</button>
                                                    <button type="button" onclick="removeBlock(this)" class="text-xs text-red-500 hover:text-red-700">Remove</button>
                                                </div>
                                            </div>
                                            <div id="links-list-<?php echo e($loop->index); ?>" class="space-y-2">
                                                <?php $__empty_1 = true; $__currentLoopData = $block->links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                    <div class="flex items-center justify-between bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm">
                                                        <input type="hidden" name="blocks[<?php echo e($loop->parent->index); ?>][link_texts][]" value="<?php echo e($link->linked_page_title); ?>">
                                                        <input type="hidden" name="blocks[<?php echo e($loop->parent->index); ?>][link_urls][]" value="<?php echo e($link->linked_page_url); ?>">
                                                        <div class="min-w-0">
                                                            <p class="font-medium text-blue-600 truncate"><?php echo e($link->linked_page_title); ?></p>
                                                            <p class="text-xs text-gray-400 truncate"><?php echo e($link->linked_page_url); ?></p>
                                                        </div>
                                                ...
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                                    <p id="links-empty-<?php echo e($loop->index); ?>" class="text-xs text-gray-400 italic">No links yet. Click + Add Link above.</p>
                                                <?php endif; ?>
                                            </div>
                                        <?php endif; ?>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 sticky top-6">
                    ...
                    <div class="p-5 space-y-4">
                        <div>
                            ...
                            <select name="status"
                                    class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <option value="draft" <?php echo e(old('status', $seoPage->status) === 'draft' ? 'selected' : ''); ?>>Draft</option>
                                <option value="published" <?php echo e(old('status', $seoPage->status) === 'published' ? 'selected' : ''); ?>>Published</option>
                                <option value="archived" <?php echo e(old('status', $seoPage->status) === 'archived' ? 'selected' : ''); ?>>Archived</option>
                            </select>
                        </div>
                        <button type="submit"
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                    ...
                    <div class="p-5">
                        <?php if($seoPage->featured_image): ?>
                            <div id="featured-preview" class="mb-3">
                                <img id="featured-preview-img"
                                     src="<?php echo e(asset('storage/' . $seoPage->featured_image)); ?>"
                        ...
                        <label id="featured-drop-zone"
                            ...
                            <div id="featured-upload-prompt" class="<?php echo e($seoPage->featured_image ? 'hidden' : ''); ?>">
...
<script>
(function () {
    let blockIndex = <?php echo e($seoPage->blocks->count()); ?>;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views\admin\seo_pages\edit.blade.php ENDPATH**/ ?>