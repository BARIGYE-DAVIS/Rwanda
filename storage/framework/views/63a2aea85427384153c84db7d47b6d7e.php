...
<?php $__env->startSection('title', $gallery->title . ' - Safari Photo Gallery'); ?>
<?php $__env->startSection('meta_description', $gallery->meta_description); ?>
<?php $__env->startSection('meta_keywords', $gallery->meta_keywords); ?>

<?php $__env->startPush('structured_data'); ?>
<script type="application/ld+json">
<?php echo json_encode($gallery->structured_data); ?>
...
<meta property="og:title" content="<?php echo e($gallery->title); ?> - Safari Photo">
<meta property="og:description" content="<?php echo e($gallery->meta_description); ?>">
<meta property="og:image" content="<?php echo e($gallery->image_url); ?>">
<meta property="og:image:alt" content="<?php echo e($gallery->alt_text); ?>">
<meta property="og:site_name" content="Rwanda Buget Safaris">

<!-- Twitter -->
<meta property="twitter:card" content="summary_large_image">
<meta property="twitter:url" content="<?php echo e(url()->current()); ?>">
<meta property="twitter:title" content="<?php echo e($gallery->title); ?>">
<meta property="twitter:description" content="<?php echo e($gallery->meta_description); ?>">
<meta property="twitter:image" content="<?php echo e($gallery->image_url); ?>">
        ...
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                <li class="inline-flex items-center">
                    <a href="<?php echo e(route('index')); ?>" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="<?php echo e(route('gallery.index')); ?>" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2">
                            Photo Gallery
                        </a>
                    </div>
                </li>
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2"><?php echo e($gallery->category_label); ?></span>
                    </div>
                </li>
            </ol>
        </nav>
            ...
            <article class="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div class="relative">
                    ...
                    <div class="absolute top-4 right-4 flex space-x-2">
                        <!-- Download Button -->
                        <a href="<?php echo e($gallery->image_url); ?>" 
                           download="<?php echo e($gallery->slug); ?>.jpg"
                ...
                <div class="p-6">
                    <header class="mb-6">
                        ...
                        <div class="flex flex-wrap items-center gap-4 mt-4 text-sm text-gray-600">
                            <time datetime="<?php echo e($gallery->created_at->toISOString()); ?>" class="flex items-center">
                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                                </svg>
                                <?php echo e($gallery->created_at->format('F j, Y')); ?>
                    ...
                    <div class="border-t border-gray-200 pt-6 mt-6">
                        ...
                        <div class="flex space-x-3">
                            ...
                            <a href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode(url()->current())); ?>&text=<?php echo e(urlencode($gallery->title)); ?>" 
                               target="_blank"
                            ...
                            <a href="https://pinterest.com/pin/create/button/?url=<?php echo e(urlencode(url()->current())); ?>&media=<?php echo e(urlencode($gallery->image_url)); ?>&description=<?php echo e(urlencode($gallery->title)); ?>" 
                               target="_blank"
        ...
        <div class="lg:col-span-1">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
                ...
                <div class="space-y-3">
                    ...
                    <a href="<?php echo e(route('gallery.index', ['category' => $gallery->category])); ?>" 
                       class="flex items-center text-gray-600 hover:text-gray-800 transition-colors">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path>
                        </svg>
                        More <?php echo e($gallery->category_label); ?> Photos
                    </a>
                </div>
            </div>
                    ...
                    <div class="mt-4">
                        <a href="<?php echo e(route('gallery.index', ['category' => $gallery->category])); ?>" 
                           class="inline-flex items-center text-sm text-green-600 hover:text-green-700 transition-colors">
                            View all <?php echo e($gallery->category_label); ?> photos
        ...
        shareBtn.addEventListener('click', async () => {
            try {
                await navigator.share({
                    title: '<?php echo e($gallery->title); ?>',
                    text: '<?php echo e($gallery->meta_description); ?>',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views\gallery\show.blade.php ENDPATH**/ ?>