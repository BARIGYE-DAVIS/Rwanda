...
<div class="activities-section bg-gray-400 py-10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-2xl font-bold text-gray-900">Tour Activities</h2>
            <a href="<?php echo e(url('/activities')); ?>" class="text-white hover:text-white text-sm font-medium">View all &rarr;</a>
        </div>
        ...
        <div class="relative">
            ...
            <div id="activities-container" class="overflow-hidden">
                <div id="activities-track" class="flex space-x-6 track will-change-transform">
                    <?php $__currentLoopData = $activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <a href="<?php echo e($link); ?>" class="activity-card flex-shrink-0 w-64 bg-white rounded-lg overflow-hidden border hover:shadow-md transition" aria-label="<?php echo e($activity->name ?? 'Activity'); ?>">
                            <div class="h-40 bg-gray-200 overflow-hidden">
                                <img src="<?php echo e($imgSrc); ?>" alt="<?php echo e($activity->name ?? 'Activity'); ?>" class="w-full h-full object-cover transform transition duration-500 hover:scale-105" loading="lazy" decoding="async">
                            </div>
                            <div class="p-3">
                                <h3 class="text-sm font-semibold text-gray-800"><?php echo e(Str::limit($activity->name ?? 'Activity', 40)); ?></h3>

                                <?php if(!empty($activity->destination?->name)): ?>
                                    <p class="text-xs text-gray-500 mt-1"><?php echo e($activity->destination->name); ?></p>
                                <?php endif; ?>

                                <?php if(!empty($desc)): ?>
                                    <p class="text-xs text-gray-600 mt-2"><?php echo e(Str::limit(strip_tags($desc), 100)); ?></p>
                                <?php else: ?>
            ...
            <div id="act-indicators" class="mt-4 flex items-center justify-center space-x-2" role="tablist" aria-hidden="false">
                <?php for($i = 0; $i < $count; $i++): ?>
                    <button class="act-indicator w-2 h-2 rounded-full bg-gray-300 hover:bg-gray-400" data-index="<?php echo e($i); ?>" aria-label="Show activity <?php echo e($i + 1); ?>" role="tab" aria-selected="<?php echo e($i === 0 ? 'true' : 'false'); ?>"></button>
                <?php endfor; ?>
            </div>
        </div>
    </div>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views\partials\activities-carousel.blade.php ENDPATH**/ ?>