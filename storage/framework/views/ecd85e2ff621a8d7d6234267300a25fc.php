...
<?php $__env->startSection('title', 'Edit Gallery Image - Admin Dashboard'); ?>
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Edit: <?php echo e(Str::limit($gallery->title, 30)); ?></span>
                            </div>
                        </li>
                    </ol>
                </nav>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="p-6">
                    ...
                    <div class="space-y-2 text-sm">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium"><?php echo e($gallery->category_label); ?></span>
                        </div>
                        
                        <div class="flex justify-between">
                            <span class="text-gray-600">Created:</span>
                            <span><?php echo e($gallery->created_at->format('M d, Y')); ?></span>
                        </div>
                        
                        <div class="flex justify-between">
                            <span class="text-gray-600">Updated:</span>
                            <span><?php echo e($gallery->updated_at->format('M d, Y')); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 p-3 bg-gray-50 rounded-lg">
                        ...
                        <a href="<?php echo e(route('gallery.show', $gallery->slug)); ?>" 
                           ...
                           class="text-sm text-blue-600 hover:text-blue-800 break-all">
                            <?php echo e(route('gallery.show', $gallery->slug)); ?>
                    ...
                    <div class="mt-4 flex space-x-2">
                         <form action="<?php echo e(route('admin.gallery.toggle-visibility', $gallery)); ?>" 
                    method="POST" class="inline-block">
                  <?php echo csrf_field(); ?>
            <button type="submit" 
            class="w-10 h-10 rounded-full flex items-center justify-center text-white transition-colors <?php echo e($gallery->is_visible ? 'bg-green-600 hover:bg-green-700' : 'bg-gray-600 hover:bg-gray-700'); ?>"
            title="<?php echo e($gallery->is_visible ? 'Hide' : 'Show'); ?>">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white shadow rounded-lg">
                ...
                <form action="<?php echo e(route('admin.gallery.update', $gallery)); ?>" method="POST" enctype="multipart/form-data" class="px-6 py-6 space-y-6" id="galleryForm">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($key); ?>" <?php echo e(old('category', $gallery->category) == $key ? 'selected' : ''); ?>>
                                        <?php echo e($label); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       id="slug" 
                                       name="slug" 
                                       value="<?php echo e(old('slug', $gallery->slug)); ?>" 
                                       required
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       id="alt_text" 
                                       name="alt_text" 
                                       value="<?php echo e(old('alt_text', $gallery->alt_text)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mt-6">
                            ...
                            <input type="text" 
                                   id="meta_keywords" 
                                   name="meta_keywords" 
                                   value="<?php echo e(old('meta_keywords', $gallery->meta_keywords)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mt-6">
                            ...
                            <input type="text" 
                                   id="tags" 
                                   name="tags" 
                                   value="<?php echo e(old('tags', implode(', ', $gallery->formatted_tags))); ?>" 
...
unset($__errorArgs, $__bag); ?>"
                                      placeholder="Write a brief description or caption for this image..."><?php echo e(old('caption', $gallery->caption)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                      placeholder="SEO description for search engines and social media sharing..."><?php echo e(old('meta_description', $gallery->meta_description)); ?></textarea>
                            <div class="flex justify-between mt-1">
                    ...
                    <div class="border-t border-gray-200 pt-6">
                        ...
                        <div class="flex items-center">
                            <input id="is_visible" 
                                   ...
                                   type="checkbox" 
                                   value="1"
                                   <?php echo e(old('is_visible', $gallery->is_visible) ? 'checked' : ''); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let originalSlug = '<?php echo e($gallery->slug); ?>';
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views\admin\gallery\edit.blade.php ENDPATH**/ ?>