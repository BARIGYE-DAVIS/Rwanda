...
<div class="min-h-screen py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form id="category-form" action="<?php echo e(route('admin.blog-categories.store')); ?>" method="POST" enctype="multipart/form-data" class="bg-white border border-slate-200 rounded-lg shadow-sm p-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <div class="mt-2 flex gap-2">
                        <input id="slug" name="slug" type="text" value="<?php echo e(old('slug')); ?>" placeholder="auto-generated from name"
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="4" class="mt-2 block w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"><?php echo e(old('description')); ?></textarea>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input id="icon" name="icon" type="text" value="<?php echo e(old('icon')); ?>" placeholder="e.g. fas fa-leaf or heroicon-class"
                               class="mt-2 block w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500">
                ...
                <div>
                    ...
                    <input id="order" name="order" type="number" value="<?php echo e(old('order', 0)); ?>" class="mt-2 w-40 px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views\admin\blog_categories\create.blade.php ENDPATH**/ ?>