    ...
    <div class="container mx-auto px-4 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <a href="<?php echo e(route('index')); ?>" class="flex items-center gap-2 shrink-0">
                <img class="h-9 w-auto" src="<?php echo e(asset('images/logo.jpeg')); ?>" alt="Rwanda Budget Safaris">
                <div class="flex flex-col leading-tight">
                    <span class="text-lg font-bold text-green-700">Uganda & Rwanda Budget Safaris</span>
                    <span class="text-xs font-medium text-gray-500 -mt-0.5">Next Gen Safaris</span>
                </div>
            </a>
            ...
            <div class="hidden lg:flex items-center gap-1">
                ...
                <a href="<?php echo e(route('contact')); ?>"
                   class="px-3 py-2 text-sm font-medium rounded-md transition-colors
                          <?php echo e(request()->routeIs('contact') ? 'text-green-700 bg-green-50' : 'text-gray-700 hover:text-green-700 hover:bg-gray-50'); ?>">
                    Contact
                </a>
