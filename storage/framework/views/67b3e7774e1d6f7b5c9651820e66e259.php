...
<head>
    ...
    <title><?php echo e($subject ?? $brandName); ?></title>
    ...
    <style>
        ...
        * { -ms-text-size-adjust:100%; -webkit-text-size-adjust:100%; }
        ...
        .header { padding:18px 22px; background: <?php echo e($brandColor); ?>; color:#ffffff; }
        ...
        .btn {
            ...
            padding:12px 16px;
            background: <?php echo e($brandColor); ?>;
    ...
    <tr>
        <td>
            <table role="presentation" width="100%" class="card">
                <tr>
                    <td class="header">
                        <div class="brand"><?php echo e($brandName); ?></div>
                        <?php if(!empty($subject)): ?>
                            <div class="subtitle"><?php echo e($subject); ?></div>
                        <?php endif; ?>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="body">
                        ...
                        <div class="muted">
                            This email was sent from <?php echo e($brandName); ?>.
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="footer">
                        <div class="muted">
                            <?php echo e($footerNote ?? 'If you did not expect this message, you can ignore it.'); ?>
...
</html><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views\admin\emails\message.blade.php ENDPATH**/ ?>