<div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 group">
    ...
    <div class="relative h-64 overflow-hidden">
        ...
        <div class="absolute top-4 right-4">
            <span class="bg-white/90 backdrop-blur text-gray-800 px-3 py-1 rounded-full text-sm font-semibold">
                <?php echo e(isset($tour->itineraries) ? count($tour->itineraries) : '5'); ?> Days
            </span>
        </div>

        <!-- Type Badge -->
        <?php if(isset($tour->type)): ?>
    ...
    <div class="p-6">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <?php if(isset($tour->prices) && $tour->prices->count() > 0): ?>
...
</div><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views\tours\partials\tour-card.blade.php ENDPATH**/ ?>