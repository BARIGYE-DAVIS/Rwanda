...
<?php $__env->startSection('title', 'Tourist Information | Uganda Safari Travel Guide | Calm Africa Safaris'); ?>
<?php $__env->startSection('meta_description', 'Complete Uganda safari travel guide. Visa requirements, East Africa Tourist Visa, health, best time to visit, packing, safety and more.'); ?>
...
<header class="relative bg-gradient-to-r from-green-800 via-green-700 to-emerald-600 py-20 md:py-28 overflow-hidden">
    ...
    <div class="relative z-10 container mx-auto px-4 text-center text-white">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4 mb-10 no-print">
            <a href="<?php echo e(route('tourist-info.download-pdf')); ?>"
        ...
        <div class="flex flex-wrap justify-center gap-2">
            <?php $__currentLoopData = [
            ...
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$href, $icon, $label]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e($href); ?>"
                   class="inline-flex items-center gap-1.5 bg-white/15 hover:bg-white/30 backdrop-blur text-white px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 hover:scale-105">
                    <i class="fa-solid <?php echo e($icon); ?> text-xs opacity-80"></i> <?php echo e($label); ?>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm mb-6">
                ...
                <div class="grid grid-cols-3 gap-4 mb-5">
                    <?php $__currentLoopData = [['$50','Per person (USD)'],['90 Days','Maximum stay'],['1 Country','Uganda only']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$v,$l]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-green-50 rounded-xl p-4 text-center">
                        <div class="text-2xl sm:text-3xl font-black text-green-700"><?php echo e($v); ?></div>
                        <div class="text-xs text-gray-600 mt-1"><?php echo e($l); ?></div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                <ul class="space-y-2 text-sm text-gray-700">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$ico,$txt]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="flex items-start gap-3 bg-gray-50 rounded-lg p-3">
                        <i class="fa-solid <?php echo e($ico); ?> text-green-500 mt-0.5 flex-shrink-0 w-4"></i>
            ...
            <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                    ...
                    ?>
                    <?php $__currentLoopData = $docs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$ico,$col,$txt]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex items-start gap-3 bg-gray-50 rounded-xl p-3">
                        <div class="w-8 h-8 rounded-lg <?php echo e($cmap[$col]); ?> flex items-center justify-center flex-shrink-0">
                            <i class="fa-solid <?php echo e($ico); ?> text-sm"></i>
                        </div>
                        <span class="text-gray-700 text-sm pt-1.5"><?php echo e($txt); ?></span>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
    ...
    <section id="eatv" class="py-16 bg-gray-50 section-anchor">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-3 gap-4 mb-8">
                <?php $__currentLoopData = [['$100','Visa fee (USD)','fa-money-bill-wave'],['90 Days','Maximum stay','fa-calendar-days'],['3 Countries','Uganda · Kenya · Rwanda','fa-flag']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$v,$l,$i]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="eatv-gradient rounded-2xl p-5 text-center text-white shadow">
                    <i class="fa-solid <?php echo e($i); ?> text-teal-200 text-lg mb-2"></i>
                    <div class="text-xl sm:text-3xl font-black"><?php echo e($v); ?></div>
                    <div class="text-xs text-teal-200 mt-1"><?php echo e($l); ?></div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
                ...
                <div class="divide-y divide-gray-100">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 hover:bg-teal-50 transition-colors">
                        <div class="sm:col-span-1 flex items-start gap-3 px-5 py-4 bg-gray-50 sm:bg-transparent border-b sm:border-b-0 sm:border-r border-gray-100">
                            <i class="fa-solid <?php echo e($ico); ?> text-teal-500 mt-0.5 w-4 flex-shrink-0"></i>
                            <span class="font-semibold text-gray-800 text-sm"><?php echo e($lbl); ?></span>
                        </div>
                        <div class="sm:col-span-2 px-5 py-4 text-sm text-gray-700"><?php echo e($val); ?></div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
            ...
            <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm">
                ...
                <div class="p-6 space-y-5">
                    ...
                    ?>
                    <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => [$title, $desc]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex gap-4">
                        <div class="w-8 h-8 bg-teal-600 text-white rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0 mt-0.5"><?php echo e($i+1); ?></div>
                        <div>
                            <div class="font-semibold text-gray-900 text-sm"><?php echo e($title); ?></div>
                            <div class="text-gray-600 text-sm mt-0.5"><?php echo $desc; ?></div>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$vac,$status,$badgeCls,$notes]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-blue-50 transition-colors">
                                <td class="p-3 font-medium text-gray-900"><?php echo e($vac); ?></td>
                                <td class="p-3"><span class="px-2.5 py-1 rounded-full text-xs font-semibold <?php echo e($badgeCls); ?>"><?php echo e($status); ?></span></td>
                                <td class="p-3 text-gray-600"><?php echo e($notes); ?></td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                    ...
                    <ul class="space-y-2 text-sm text-gray-700">
                        ...
                        <li class="flex items-start gap-2"><i class="fa-solid fa-circle-dot text-orange-400 text-xs mt-1.5 flex-shrink-0"></i><span><?php echo e($tip); ?></span></li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </div>
                <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                    ...
                    <ul class="space-y-2 text-sm text-gray-700">
                        ...
                        <li class="flex items-start gap-2"><i class="fa-solid fa-circle-dot text-blue-400 text-xs mt-1.5 flex-shrink-0"></i><span><?php echo e($tip); ?></span></li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </div>
            </div>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div class="bg-yellow-50 border border-yellow-200 rounded-2xl p-6">
                    ...
                    <?php $__currentLoopData = [['June – September','Long dry season. Best game viewing. Ideal gorilla trekking — drier trails. Peak season, book early.'],['December – February','Short dry season. Excellent wildlife and birdwatching. Quieter with slightly lower prices.']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$p,$d]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-xl p-4 mb-3 last:mb-0">
                        <div class="font-bold text-gray-900 text-sm mb-1"><i class="fa-regular fa-calendar mr-1 text-yellow-500"></i><?php echo e($p); ?></div>
                        <p class="text-gray-600 text-sm"><?php echo e($d); ?></p>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                <div class="bg-blue-50 border border-blue-200 rounded-2xl p-6">
                    ...
                    <?php $__currentLoopData = [['March – May','Long rains. Lush landscapes, excellent birdwatching. Lower prices and far fewer tourists.'],['October – November','Short rains. Brief afternoon showers. Wildlife still excellent. Good shoulder-season value.']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$p,$d]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-xl p-4 mb-3 last:mb-0">
                        <div class="font-bold text-gray-900 text-sm mb-1"><i class="fa-regular fa-calendar mr-1 text-blue-500"></i><?php echo e($p); ?></div>
                        <p class="text-gray-600 text-sm"><?php echo e($d); ?></p>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$m,$w,$wl,$cr,$r]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-yellow-50 transition-colors">
                                <td class="p-3 font-bold text-gray-800"><?php echo e($m); ?></td>
                                <td class="p-3 text-gray-600"><?php echo e($w); ?></td>
                                <td class="p-3 text-gray-600"><?php echo e($wl); ?></td>
                                <td class="p-3 text-gray-600"><?php echo e($cr); ?></td>
                                <td class="p-3 text-amber-500 text-xs"><?php echo e($r); ?></td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$role,$amount]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex justify-between items-center text-sm py-2 border-b border-gray-100 last:border-0">
                        <span class="text-gray-700 flex items-center gap-2"><i class="fa-solid fa-user text-gray-300 w-4"></i><?php echo e($role); ?></span>
                        <span class="font-bold text-green-600"><?php echo e($amount); ?></span>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
    ...
    <section id="packing" class="py-16 bg-gray-50 section-anchor">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                <?php $__currentLoopData = $cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$ico,$col,$title,$items]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $c=$cmap[$col]; ?>
                <div class="<?php echo e($c['bg']); ?> <?php echo e($c['border']); ?> border rounded-2xl overflow-hidden shadow-sm">
                    <div class="<?php echo e($c['hdr']); ?> px-4 py-3 flex items-center gap-2">
                        <i class="fa-solid <?php echo e($ico); ?> text-white/80 text-sm"></i>
                        <span class="font-bold text-white text-sm"><?php echo e($title); ?></span>
                    </div>
                    <ul class="p-4 space-y-1.5">
                        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="flex items-start gap-2 text-xs text-gray-700">
                            <i class="fa-solid fa-check <?php echo e($c['dot']); ?> mt-0.5 flex-shrink-0 text-xs"></i>
                            <span><?php echo e($item); ?></span>
                        </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
    ...
    <section id="safety" class="py-16 bg-white section-anchor">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                ...
                ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$ico,$cls,$heading,$tips]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                    <h3 class="flex items-center gap-2 text-lg font-bold text-gray-900 mb-4">
                        <i class="fa-solid <?php echo e($ico); ?> <?php echo e($cls); ?>"></i> <?php echo e($heading); ?>
                    ...
                    <ul class="space-y-2 text-sm text-gray-700">
                        ...
                        <li class="flex items-start gap-2"><i class="fa-solid fa-angles-right <?php echo e($cls); ?> mt-1 flex-shrink-0 text-xs"></i><span><?php echo e($tip); ?></span></li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="bg-white border border-gray-200 rounded-2xl p-6  hidden shadow-sm">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 gap-3 text-sm">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$ico,$lbl,$num]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-gray-50 rounded-xl p-4 text-center">
                        <i class="fa-solid <?php echo e($ico); ?> text-red-500 text-xl mb-2"></i>
                        <div class="text-xs font-semibold text-gray-700"><?php echo e($lbl); ?></div>
                        <div class="font-bold text-green-700 text-sm mt-1"><?php echo e($num); ?></div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                    ...
                    <div class="flex flex-wrap gap-2 mb-4">
                        <?php $__currentLoopData = ['Kenya Airways','Ethiopian Airlines','Emirates','Qatar Airways','KLM','British Airways','RwandAir','Turkish Airlines','Fly Dubai']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $al): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <span class="bg-indigo-100 text-indigo-700 px-2.5 py-1 rounded-full text-xs font-medium"><?php echo e($al); ?></span>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    <ul class="space-y-1 text-sm text-gray-700">
                        <?php $__currentLoopData = ['Nairobi → 1h 15min','Addis Ababa → 2h 30min','Dubai → 5h 30min','Amsterdam / London → 8–9h']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $route): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="flex items-center gap-2"><i class="fa-solid fa-arrow-right text-indigo-400 text-xs"></i><?php echo e($route); ?></li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </div>
                <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                    ...
                    <div class="space-y-3">
                        ...
                        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$ico,$mode,$note]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex gap-3 bg-indigo-50 rounded-lg p-3">
                            <i class="fa-solid <?php echo e($ico); ?> text-indigo-500 mt-0.5 flex-shrink-0 w-4"></i>
                            <div>
                                <div class="font-semibold text-gray-900 text-sm"><?php echo e($mode); ?></div>
                                <div class="text-gray-500 text-xs mt-0.5"><?php echo e($note); ?></div>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                <div class="bg-green-50 border border-green-200 rounded-2xl p-6">
                    ...
                    <ul class="space-y-2 text-sm text-gray-700">
                        <?php $__currentLoopData = ['Greet people warmly — greetings are very important in Ugandan culture','Use both hands or right hand when giving/receiving','Dress modestly in rural areas and religious sites','Ask permission before photographing people','Remove shoes before entering a mosque or traditional home','Bargain respectfully at markets — expected','Learn a few Luganda words — always appreciated']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="flex items-start gap-2"><i class="fa-solid fa-check text-green-500 mt-0.5 flex-shrink-0 text-xs"></i><span><?php echo e($d); ?></span></li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </div>
                <div class="bg-red-50 border border-red-200 rounded-2xl p-6">
                    ...
                    <ul class="space-y-2 text-sm text-gray-700">
                        <?php $__currentLoopData = ['Do NOT photograph military, government buildings, or airports — illegal','Do NOT wear camouflage — illegal for civilians','Avoid public displays of affection beyond holding hands','Do not pass items with your left hand','Do not raise your voice or show impatience','Do not litter — strict laws apply','Do NOT bring plastic bags — banned in Uganda']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="flex items-start gap-2"><i class="fa-solid fa-xmark text-red-400 mt-0.5 flex-shrink-0 text-xs"></i><span><?php echo e($d); ?></span></li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </div>
            </div>
            <div class="bg-purple-50 border border-purple-200 rounded-2xl p-6">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3 text-sm">
                    <?php $__currentLoopData = ['Hello'=>'Oli otya','Good morning'=>'Wasuze otya','Thank you'=>'Webale nyo','You\'re welcome'=>'Kale','Yes'=>'Yee','No'=>'Nedda','Please'=>'Mwattu','How much?'=>'Semanga?','Welcome'=>'Tukusanyukidde','Good'=>'Bulungi']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $en=>$lg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-xl p-3 text-center shadow-sm">
                        <div class="text-xs text-gray-500"><?php echo e($en); ?></div>
                        <div class="font-bold text-purple-700 mt-0.5"><?php echo e($lg); ?></div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm">
                ...
                <div class="divide-y divide-gray-100">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$r,$t,$n]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-0 hover:bg-sky-50 transition-colors px-5 py-4">
                        <div class="sm:w-1/3 font-semibold text-gray-900 text-sm flex items-center gap-2">
                            <i class="fa-solid fa-location-dot text-sky-400 text-xs flex-shrink-0"></i><?php echo e($r); ?>

                        </div>
                        <div class="sm:w-1/6 font-bold text-sky-600 text-sm"><?php echo e($t); ?></div>
                        <div class="sm:flex-1 text-gray-600 text-sm"><?php echo e($n); ?></div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
            ...
            <div class="space-y-3">
                ...
                <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm">
                    <button onclick="toggleFaq(<?php echo e($i); ?>)"
                            ...
                            id="faq-btn-<?php echo e($i); ?>">
                        <span class="font-semibold text-gray-900 text-sm">
                            <i class="fa-solid fa-circle-question text-green-400 mr-2"></i><?php echo e($q); ?>

                        </span>
                        <i id="faq-icon-<?php echo e($i); ?>" class="fa-solid fa-chevron-down text-green-500 flex-shrink-0 text-sm transition-transform duration-300"></i>
                    </button>
                    <div id="faq-body-<?php echo e($i); ?>" class="hidden px-5 pb-5 text-gray-600 text-sm leading-relaxed border-t border-gray-100 pt-4">
                        <?php echo e($a); ?>
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views\pages\tourist-information.blade.php ENDPATH**/ ?>