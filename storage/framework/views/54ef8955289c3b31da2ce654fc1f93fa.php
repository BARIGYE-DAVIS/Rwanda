...
<?php $__env->startSection('title', 'Plan Your Custom Safari Tour'); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="name" required
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="email" name="email" required
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
<script>
    const countries = <?php echo json_encode($countries->pluck('name', 'flag_icon'), 512) ?>;
    const countryInput = document.getElementById('countryInput');
    const countryDropdown = document.getElementById('countryDropdown');
    
    // Convert to array for easier filtering
    const countriesArray = <?php echo json_encode($countries->map(function($country) {
        return [
            'name' => $country->name, 'flag' => $country->flag_icon
        ];
    })->values(), 512) ?>;
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="duration"
                                ...
                                <option value="3-5 days" <?php echo e(old('duration') == '3-5 days' ? 'selected' : ''); ?>>3-5 days</option>
                                <option value="6-9 days" <?php echo e(old('duration') == '6-9 days' ? 'selected' : ''); ?>>6-9 days</option>
                                <option value="10-14 days" <?php echo e(old('duration') == '10-14 days' ? 'selected' : ''); ?>>10-14 days</option>
                                <option value="15+ days" <?php echo e(old('duration') == '15+ days' ? 'selected' : ''); ?>>15+ days</option>
                                <option value="Flexible" <?php echo e(old('duration') == 'Flexible' ? 'selected' : ''); ?>>Flexible</option>
                            </select>
                        </div>
                                    ...
                                    <label class="destination-item flex items-start p-3 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-green-400 hover:bg-green-50 transition-all duration-200"
                                        ...
                                        <div class="ml-3 flex-1">
                                            <div class="flex items-start justify-between">
                                                <div class="flex-1">
                                                    <h4 class="font-bold text-gray-800 text-sm"><?php echo e($destination->name); ?></h4>
                                                    <p class="text-xs text-gray-600 mt-1 line-clamp-2"><?php echo e(Str::limit($destination->description, 100)); ?></p>
                                                </div>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 mb-6">
                                    ...
                                    <label class="activity-item flex items-start p-3 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-orange-400 hover:bg-orange-50 transition-all duration-200"
                                        ...
                                        <div class="ml-3 flex-1">
                                            <div class="flex items-start justify-between">
                                                <div class="flex-1">
                                                    <h4 class="font-bold text-gray-800 text-sm"><?php echo e($activity->name); ?></h4>
                                                    <p class="text-xs text-gray-600 mt-1 line-clamp-2"><?php echo e(Str::limit($activity->description, 100)); ?></p>
                                                </div>
                                                <?php if($activity->image || $activity->icon): ?>
                                                <div class="ml-2 flex-shrink-0">
                                                    ...
                                                    <img src="<?php echo e(asset('storage/' . $activity->icon)); ?>" 
                                                         alt="<?php echo e($activity->name); ?>"
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="medical_conditions" rows="2"
                                      class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"
                                      placeholder="Please let us know if you have any medical conditions or accessibility needs we should be aware of..."><?php echo e(old('medical_conditions')); ?></textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="special_requests" rows="4"
                                      class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"
                                      placeholder="Tell us anything else you'd like us to know about your dream safari..."><?php echo e(old('special_requests')); ?></textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="heard_from"
                                ...
                                <option value="Google Search" <?php echo e(old('heard_from') == 'Google Search' ? 'selected' : ''); ?>>Google Search</option>
                                <option value="Social Media" <?php echo e(old('heard_from') == 'Social Media' ? 'selected' : ''); ?>>Social Media</option>
                                <option value="Friend/Family Referral" <?php echo e(old('heard_from') == 'Friend/Family Referral' ? 'selected' : ''); ?>>Friend/Family Referral</option>
                                <option value="Travel Agent" <?php echo e(old('heard_from') == 'Travel Agent' ? 'selected' : ''); ?>>Travel Agent</option>
                                <option value="Online Advertisement" <?php echo e(old('heard_from') == 'Online Advertisement' ? 'selected' : ''); ?>>Online Advertisement</option>
                                <option value="Travel Blog/Website" <?php echo e(old('heard_from') == 'Travel Blog/Website' ? 'selected' : ''); ?>>Travel Blog/Website</option>
                                <option value="Previous Customer" <?php echo e(old('heard_from') == 'Previous Customer' ? 'selected' : ''); ?>>Previous Customer</option>
                                <option value="Other" <?php echo e(old('heard_from') == 'Other' ? 'selected' : ''); ?>>Other</option>
                            </select>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views\custom-tour-requests\copy.blade.php ENDPATH**/ ?>