...
<?php $__env->startSection('title', 'Tour Bookings - Admin Dashboard'); ?>
...
<div class="container-fluid px-4 py-6">
    ...
    <div class="mb-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="mt-4 sm:mt-0 flex space-x-3">
                <a href="<?php echo e(route('admin.bookings.export')); ?>" 
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900"><?php echo e(number_format($stats['total'])); ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900"><?php echo e(number_format($stats['pending'])); ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900"><?php echo e(number_format($stats['confirmed'])); ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900"><?php echo e(number_format($stats['this_month'])); ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-white shadow rounded-lg mb-6">
        ...
        <div class="px-6 py-4">
            <form method="GET" action="<?php echo e(route('admin.bookings.index')); ?>" class="grid grid-cols-1 md:grid-cols-5 gap-4">
                <!-- Search -->
                <div>
                ...
                <div>
                    ...
                    <select name="country" id="country" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500">
                        ...
                        <?php $__currentLoopData = App\Models\Booking::select('country')->distinct()->whereNotNull('country')->pluck('country'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $countryName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div>
                    ...
                    <input type="date" 
                           name="travel_date" 
                           id="travel_date"
                           value="<?php echo e(request('travel_date')); ?>"
                           class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500">
                </div>
                ...
                <div class="flex items-end space-x-2">
                    ...
                    <a href="<?php echo e(route('admin.bookings.index')); ?>" class="px-4 py-2 bg-gray-300 border border-transparent rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-400 transition ease-in-out duration-150">
                        Clear
                    </a>
                </div>
            </form>
    ...
    <div class="bg-white shadow overflow-hidden rounded-md">
        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            <h3 class="text-lg font-medium text-gray-900">
                Safari Bookings 
                <?php if(request()->hasAny(['search', 'status', 'country', 'travel_date'])): ?>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 <?php echo e($booking->status === 'pending' ? 'bg-yellow-50 border-l-4 border-yellow-400' : ''); ?>">
                        <!-- Checkbox -->
                        <td class="px-6 py-4 whitespace-nowrap">
                            <input type="checkbox" name="selected_bookings[]" value="<?php echo e($booking->id); ?>" class="booking-checkbox rounded border-gray-300 text-green-600 shadow-sm focus:border-green-300 focus:ring focus:ring-green-200 focus:ring-opacity-50">
                        </td>
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10">
                                    <div class="h-10 w-10 rounded-full bg-<?php echo e($booking->status === 'pending' ? 'yellow' : 'green'); ?>-100 flex items-center justify-center">
                                        <svg class="w-6 h-6 text-<?php echo e($booking->status === 'pending' ? 'yellow' : 'green'); ?>-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <td class="px-6 py-4">
                            <?php if($booking->tour): ?>
                            <div class="text-sm font-medium text-gray-900 mb-1"><?php echo e($booking->tour->title); ?></div>
                            <div class="text-xs text-gray-500">
                                <?php echo e($booking->group_size); ?> • 
                                <?php echo e($booking->tour->itineraries->count() ?: 'Multi'); ?> <?php echo e($booking->tour->itineraries->count() == 1 ? 'Day' : 'Days'); ?>

                            </div>
                            <?php else: ?>
                            <div class="text-sm text-gray-500 italic">Custom Safari Request</div>
                            <div class="text-xs text-gray-500"><?php echo e($booking->group_size); ?></div>
                            <?php endif; ?>
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">
                                <?php echo e(Carbon\Carbon::parse($booking->travel_date)->format('M d, Y')); ?>

                            </div>
                            <div class="text-xs text-gray-500">
                                <?php echo e(Carbon\Carbon::parse($booking->travel_date)->diffForHumans()); ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            <div><?php echo e($booking->created_at->format('M d, Y')); ?></div>
                            <div class="text-xs text-gray-400"><?php echo e($booking->created_at->format('H:i A')); ?></div>
                            <div class="text-xs text-gray-400"><?php echo e($booking->created_at->diffForHumans()); ?></div>
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex items-center space-x-2">
                                ...
                                <a href="mailto:<?php echo e($booking->email); ?>?subject=Re: Your Safari Booking&body=Dear <?php echo e($booking->name); ?>,%0D%0A%0D%0AThank you for your safari booking inquiry.%0D%0A%0D%0A"
                                ...
                                <form action="<?php echo e(route('admin.bookings.destroy', $booking->id)); ?>" method="POST" class="inline-block" onsubmit="return confirm('Are you sure you want to delete this booking?')">
                                    <?php echo csrf_field(); ?>
        ...
        <div class="text-center py-12">
            ...
            <?php if(request()->hasAny(['search', 'status', 'country', 'travel_date'])): ?>
            <div class="mt-6">
                <a href="<?php echo e(route('admin.bookings.index')); ?>" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700">
                    Clear Filters
                </a>
            </div>
            <?php endif; ?>
...
<!-- Bulk Action Form -->
<form id="bulkActionForm" action="<?php echo e(route('admin.bookings.bulk')); ?>" method="POST" style="display: none;">
    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views\admin\bookings\index.blade.php ENDPATH**/ ?>