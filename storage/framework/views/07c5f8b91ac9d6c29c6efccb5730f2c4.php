...
<table width="640" cellpadding="0" cellspacing="0" border="0" style="max-width:640px;width:100%;">
  ...
  <tr><td style="background:#fff;padding:44px 48px 32px;">
    ...
    <h2 style="margin:0 0 16px;color:#0a1628;font-size:24px;font-weight:400;line-height:1.3;">Hello <strong style="color:#1a5c35;"><?php echo e($booking->name); ?></strong>,</h2>
    <p style="margin:0 0 24px;color:#475569;font-size:14px;line-height:1.9;">Thank you for choosing Rwanda Buget Safaris. We have received your booking request for <strong style="color:#0a1628;"><?php echo e($booking->tour->title); ?></strong> and our expert team will reach out within <strong>24 hours</strong>. Below is your complete safari itinerary and booking details.</p>
    <div style="background:#f8fafc;border:1px solid #e2e8f0;border-left:4px solid #c9a84c;border-radius:0 8px 8px 0;padding:14px 18px;">
      ...
      <div style="font-family:'Courier New',monospace;font-size:20px;color:#0a1628;font-weight:700;letter-spacing:2px;margin-top:4px;">#<?php echo e($booking->id); ?></div>
    </div>
  </td></tr>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid #e2e8f0;border-radius:12px;overflow:hidden;">
      <tr style="background:#f8fafc;">
        <td colspan="2" style="padding:14px 18px;border-bottom:1px solid #e2e8f0;">
          ...
          <div style="font-size:15px;color:#0a1628;font-weight:600;"><?php echo e($booking->tour->title); ?></div>
        </td>
      </tr>
      <tr>
        <td width="50%" style="padding:14px 18px;border-bottom:1px solid #e2e8f0;border-right:1px solid #e2e8f0;">
          ...
          <div style="font-size:14px;color:#1e293b;font-weight:600;"><?php echo e(\Carbon\Carbon::parse($booking->travel_date)->format('F j, Y')); ?></div>
        </td>
        <td width="50%" style="padding:14px 18px;border-bottom:1px solid #e2e8f0;">
          ...
          <div style="font-size:14px;color:#1e293b;font-weight:600;"><?php echo e($booking->group_size); ?></div>
        </td>
      </tr>
      <tr>
        <td width="50%" style="padding:14px 18px;border-right:1px solid #e2e8f0;<?php echo e(!empty($booking->total_cost)?'border-bottom:1px solid #e2e8f0;':''); ?>">
          <div style="font-size:11px;color:#94a3b8;letter-spacing:1px;text-transform:uppercase;margin-bottom:3px;">Country</div>
          <div style="font-size:14px;color:#1e293b;font-weight:600;"><?php echo e($booking->country); ?></div>
        </td>
        <td width="50%" style="padding:14px 18px;<?php echo e(!empty($booking->total_cost)?'border-bottom:1px solid #e2e8f0;':''); ?>">
          <div style="font-size:11px;color:#94a3b8;letter-spacing:1px;text-transform:uppercase;margin-bottom:3px;">Duration</div>
          <div style="font-size:14px;color:#1e293b;font-weight:600;"><?php echo e($booking->tour->itinerary->count()); ?> Days</div>
        </td>
      </tr>
      ...
      <tr style="background:#f0fdf4;">
        <td colspan="2" style="padding:16px 18px;">
          ...
          <span style="font-size:26px;color:#1a5c35;font-weight:700;">$<?php echo e(number_format($booking->total_cost, 2)); ?></span>
  ...
  <tr><td style="background:#fff;padding:0 48px 48px;">
    <div style="background:linear-gradient(135deg,#0a1628,#0d2d1f);border-radius:14px;padding:30px;">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:18px;">
        ...
        <tr><td style="padding:10px 14px;background:rgba(255,255,255,0.06);border-radius:8px;font-size:14px;color:rgba(255,255,255,0.8);">💬 &nbsp;<?php echo e($booking->whatsapp ?? 'WhatsApp not provided'); ?></td></tr>
      </table>
  ...
  <tr><td style="background:#0a1628;border-radius:0 0 16px 16px;">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr><td align="center" style="padding:24px 40px;">
        <p style="margin:0 0 4px;font-size:11px;color:rgba(255,255,255,0.3);letter-spacing:2px;text-transform:uppercase;">Booking ID #<?php echo e($booking->id); ?></p>
...
</html><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views\emails\booking-confirmation.blade.php ENDPATH**/ ?>