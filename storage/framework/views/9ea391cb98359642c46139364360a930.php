...
<?php $__env->startSection('title', ucfirst($category) . ' Safaris - Safari Tours | Calm Africa Safaris'); ?>
<?php $__env->startSection('meta_description', 'Discover amazing ' . $category . ' safari tours in East Africa. Experience wildlife, culture, and adventure with our expertly guided ' . $category . ' safari packages.'); ?>
<?php $__env->startSection('meta_keywords', $category . ' safaris, ' . $category . ' tours, safari packages, East Africa tours, Tanzania safaris, Kenya safaris, Uganda safaris, wildlife tours, adventure tours, cultural tours, safari booking, ' . $category . ' safari experiences'); ?>
        ...
        <div class="max-w-4xl mx-auto">
            <div class="mb-6">
                <span class="inline-block bg-white/20 backdrop-blur text-white px-4 py-2 rounded-full text-sm font-medium mb-4">
                    <?php echo e(ucfirst($category)); ?> Category
                </span>
                <h1 class="text-4xl md:text-6xl font-bold mb-4"><?php echo e(ucfirst($category)); ?> Safaris</h1>
                <p class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
                    <?php switch($category):
                        ...
                        <?php case ('honeymoon'): ?>
                            ...
                            <?php break; ?>
                        <?php default: ?>
                            Discover the best of <?php echo e($category); ?> safari experiences in East Africa
                    <?php endswitch; ?>
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
                <div class="bg-white/10 backdrop-blur rounded-lg p-4">
                    <div class="text-2xl font-bold text-green-300"><?php echo e($tours->total()); ?></div>
                    <div class="text-sm text-gray-200">Available Tours</div>
                </div>
                <div class="bg-white/10 backdrop-blur rounded-lg p-4">
                    <div class="text-2xl font-bold text-green-300">
                        <?php if($tours->count() > 0): ?>
                            <?php echo e($tours->flatMap(function($tour) { return $tour->prices; })->count() > 0 ? 
                ...
                <div class="bg-white/10 backdrop-blur rounded-lg p-4">
                    <div class="text-2xl font-bold text-green-300">
                        <?php if($tours->count() > 0): ?>
                            <?php echo e($tours->flatMap(function($tour) { return $tour->itineraries; })->count() > 0 ? 
            ...
            <nav class="text-sm">
                <ol class="flex justify-center space-x-2 text-green-200">
                    ...
                    <li class="mx-2">/</li>
                    <li><a href="<?php echo e(route('tours.index')); ?>" class="hover:text-white transition-colors">Tours</a></li>
                    <li class="mx-2">/</li>
                    <li class="text-white"><?php echo e(ucfirst($category)); ?> Safaris</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-4xl mx-auto text-center">
                <h2 class="text-3xl font-bold text-gray-900 mb-6">
                    Why Choose <?php echo e(ucfirst($category)); ?> Safaris?
                </h2>
                <div class="text-lg text-gray-700 leading-relaxed space-y-4">
                    <?php switch($category):
                        ...
                        <?php case ('honeymoon'): ?>
                            ...
                            <?php break; ?>
                        <?php default: ?>
                            <p>Discover the beauty and diversity of <?php echo e($category); ?> safaris with our expertly crafted tours. Each experience is designed to showcase the best of East Africa while providing comfort, safety, and unforgettable memories.</p>
    ...
    <section class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-3xl font-bold text-gray-900 text-center mb-12">
                What Makes Our <?php echo e(ucfirst($category)); ?> Safaris Special
            </h2>
                ...
                <?php switch($category):
                    ...
                    <?php default: ?>
                        <div class="bg-white rounded-xl p-6 shadow-md">
                            ...
                            <p class="text-gray-600">Professional guides with extensive knowledge and experience in <?php echo e($category); ?> tours.</p>
                        </div>
                        <div class="bg-white rounded-xl p-6 shadow-md">
                            <div class="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mb-4">
                                <svg class="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-gray-900 mb-4">
                    Available <?php echo e(ucfirst($category)); ?> Safari Tours
                </h2>
                <p class="text-lg text-gray-600">
                    Choose from our carefully curated <?php echo e($category); ?> safari experiences
                </p>
            </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 group">
                        ...
                        <div class="p-6">
                            ...
                            <p class="text-gray-600 mb-4 line-clamp-3">
                                <?php echo e(Str::limit($tour->description, 120)); ?>
                            ...
                            <div class="flex items-center mb-4 text-sm text-gray-500">
                                ...
                                <span class="line-clamp-1"><?php echo e($tour->destinations ?: 'East Africa'); ?></span>
                            </div>
                                ...
                                <div>
                                    <?php if($tour->prices && $tour->prices->count() > 0): ?>
                                        ...
                                        <div class="flex items-baseline">
                                            <span class="text-2xl font-bold text-green-600">$<?php echo e(number_format($minPrice)); ?></span>
            ...
            <?php else: ?>
                ...
                <div class="text-center py-16">
                    ...
                    <h3 class="text-2xl font-bold text-gray-600 mb-4">No <?php echo e(ucfirst($category)); ?> Tours Available Yet</h3>
                    <p class="text-gray-500 mb-8 max-w-2xl mx-auto">
                        We're currently developing amazing <?php echo e($category); ?> safari experiences. 
                        In the meantime, check out our other tour categories or contact us for custom <?php echo e($category); ?> safari arrangements.
                    </p>
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <a href="<?php echo e(route('contact')); ?>" 
                           class="border-2 border-green-600 text-green-600 hover:bg-green-600 hover:text-white px-8 py-3 rounded-lg transition-colors font-semibold">
                            Request Custom <?php echo e(ucfirst($category)); ?> Safari
                        </a>
                    </div>
                </div>
            <?php endif; ?>
    ...
    <section class="bg-gradient-to-r from-green-600 to-blue-600 py-16">
        <div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            <h2 class="text-3xl md:text-4xl font-bold text-white mb-4">
                Ready for Your <?php echo e(ucfirst($category)); ?> Safari Adventure?
            </h2>
            <p class="text-xl text-green-100 mb-8 max-w-2xl mx-auto">
                Join us for an unforgettable <?php echo e($category); ?> safari experience. 
                Our expert team is ready to help you plan the perfect <?php echo e($category); ?> adventure in East Africa.
            </p>
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="<?php echo e(route('booking.create')); ?>" 
                   class="bg-white text-green-600 px-8 py-4 rounded-lg font-bold hover:bg-gray-100 transition-all duration-300 transform hover:scale-105">
                    Book <?php echo e(ucfirst($category)); ?> Safari
                </a>
                <a href="<?php echo e(route('contact')); ?>" 
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views\tours\category.blade.php ENDPATH**/ ?>