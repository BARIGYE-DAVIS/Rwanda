<?php $__env->startSection('title', $tour->meta_title ?? $tour->title . ' - Safari Tours'); ?>
<?php $__env->startSection('meta_description', $tour->meta_description ?? Str::limit($tour->description, 160)); ?>
<?php $__env->startSection('meta_keywords', $tour->meta_keywords ?? 'safari tour, ' . $tour->category . ', ' . $tour->type . ', ' . $tour->destinations); ?>
        ...
        <div class="max-w-7xl mx-auto">
            <div class="flex flex-wrap gap-2 mb-3">
                ...
                <span class="bg-white/20 backdrop-blur text-white px-3 py-1 rounded-full text-xs sm:text-sm font-semibold">
                    <?php echo e($tour->itineraries->count() ?: 'Multi'); ?> <?php echo e($tour->itineraries->count() == 1 ? 'Day' : 'Days'); ?>

                </span>
            </div>
            <h1 class="text-2xl sm:text-3xl lg:text-5xl font-bold text-white mb-3 leading-tight"><?php echo e($tour->title); ?></h1>
            <div class="flex items-center text-white/90 text-sm sm:text-base">
                ...
                <span><?php echo e($tour->destinations); ?></span>
            </div>
        </div>
    </div>
</header>
...
<nav class="bg-white border-b py-3 overflow-x-auto">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center space-x-1 text-xs sm:text-sm whitespace-nowrap">
            <a href="<?php echo e(route('index')); ?>" class="text-gray-500 hover:text-green-600">Home</a>
            <svg class="w-3 h-3 text-gray-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
            </svg>
            <a href="<?php echo e(route('tours.index')); ?>" class="text-gray-500 hover:text-green-600">Tours</a>
            <svg class="w-3 h-3 text-gray-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
            </svg>
            <span class="text-gray-900 font-medium truncate max-w-[150px] sm:max-w-none"><?php echo e($tour->title); ?></span>
        </div>
    </div>
</nav>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
        ...
        <div class="lg:col-span-2 space-y-10 lg:space-y-14">
            ...
            <section>
                ...
                <div class="prose prose-sm sm:prose max-w-none text-gray-700 leading-relaxed">
                    <?php echo nl2br(e($tour->description)); ?>
            ...
            <!-- ══════════════════════════════
                 ITINERARY ACCORDION
            ══════════════════════════════ -->
            <?php if($tour->itineraries->count() > 0): ?>
            <section>
                ...
                <div id="itineraryAccordion" class="space-y-3" aria-live="polite">
                    <?php $__currentLoopData = $tour->itineraries->sortBy('day_number'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                        ...
                        <button id="<?php echo e($buttonId); ?>"
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div class="flex-shrink-0 w-11 h-11 rounded-full bg-green-600 flex items-center justify-center">
                                    <span class="text-white font-bold text-sm"><?php echo e($day->day_number); ?></span>
                                </div>

                                <!-- Title & preview -->
                                <div class="flex-1 min-w-0">
                                    <h3 class="text-sm sm:text-base font-bold text-gray-900 leading-snug">
                                        Day <?php echo e($day->day_number); ?><?php if($day->day_title): ?> — <?php echo e($day->day_title); ?><?php endif; ?>
                                    </h3>
                                    <?php if($day->activity): ?>
                                        <p class="text-gray-500 text-xs sm:text-sm mt-0.5 line-clamp-1">
                                            <?php echo e(Str::limit(strip_tags($day->activity), 80)); ?>
                        ...
                        <!-- Accordion panel -->
                        <div id="<?php echo e($panelId); ?>"
                             role="region"
                             aria-labelledby="<?php echo e($buttonId); ?>"
                             class="accordion-panel"
                             data-day-number="<?php echo e($day->day_number); ?>"
                            ...
                            <div class="border-t border-gray-100 p-4 sm:p-6 space-y-6">
                                ...
                                <div class="prose prose-sm max-w-none text-gray-700">
                                    <?php echo nl2br(e($day->activity)); ?>

                                </div>

                                <!-- ── Day image SLIDER ── -->
                                <?php if($dayImages->count() > 0): ?>
                                <?php $sliderId = 'day-slider-' . ($day->id ?? $loop->index); ?>
                                <div class="relative" id="<?php echo e($sliderId); ?>-wrap">
                                    <div class="overflow-hidden rounded-xl">
                                        <div class="slider-track flex transition-transform duration-500 ease-in-out"
                                             id="<?php echo e($sliderId); ?>-track"
                                             data-current="0"
                                             data-total="<?php echo e($dayImages->count()); ?>">
                                            <?php $__currentLoopData = $dayImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php $src = $img->thumbnail_path ?: $img->storage_path ?: $img->image_path ?? null; ?>
                                            <div class="slider-slide flex-none w-full aspect-video sm:aspect-[16/7] overflow-hidden">
                                                <img data-src="<?php echo e($src ? asset('storage/' . ltrim($src, '/')) : ''); ?>"
                                                     alt="<?php echo e($img->caption ?? 'Day ' . $day->day_number . ' image'); ?>"
                                                     class="w-full h-full object-cover lazy-day-image">
                                            </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    </div>
                                    <?php if($dayImages->count() > 1): ?>
                                    <button onclick="sliderMove('<?php echo e($sliderId); ?>', -1)"
                                    ...
                                    <div class="absolute bottom-2 left-1/2 -translate-x-1/2 flex gap-1.5 z-10" id="<?php echo e($sliderId); ?>-dots">
                                        <?php $__currentLoopData = $dayImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <button onclick="sliderGoto('<?php echo e($sliderId); ?>', <?php echo e($loop->index); ?>)"
                                                class="slider-dot w-2 h-2 rounded-full bg-white/60 hover:bg-white transition <?php echo e($loop->first ? 'bg-white scale-125' : ''); ?>"
                                                aria-label="Go to image <?php echo e($loop->iteration); ?>"></button>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                    <div class="absolute top-2 right-2 bg-black/50 text-white text-xs px-2 py-1 rounded-full z-10" id="<?php echo e($sliderId); ?>-counter">
                                        1 / <?php echo e($dayImages->count()); ?>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-4 border-t border-gray-200">
                                    ...
                                    <div class="flex items-start text-sm text-gray-600 bg-gray-50 rounded-lg p-3">
                                        ...
                                        <div>
                                            ...
                                            <span class="ml-1"><?php echo e($acc?->name ?? $day->accommodation); ?></span>
                                            <?php if($acc?->type): ?> <span class="ml-1 text-xs text-gray-400">(<?php echo e($acc->type); ?>)</span> <?php endif; ?>
                                            <?php if($acc?->location): ?>
                                    ...
                                    <div class="flex items-center text-sm text-gray-600 bg-gray-50 rounded-lg p-3">
                                        ...
                                        <span><strong>Meals:</strong> <?php echo e($day->meals); ?></span>
                                    </div>
                                    <?php endif; ?>
                                </div>
                                <?php endif; ?>
                                ...
                                <?php if($accImages->count() > 0): ?>
                                <?php $accSliderId = 'acc-slider-' . ($day->id ?? $loop->index); ?>
                                <div>
                                    <div class="flex items-center gap-2 mb-3">
                                        ...
                                        <h4 class="text-sm font-semibold text-gray-700">
                                            <?php echo e($acc->name); ?> — Photos
                                            <span class="text-xs font-normal text-gray-400 ml-1">(<?php echo e($accImages->count()); ?>)</span>
                                        </h4>
                                    </div>
                                    <div class="relative" id="<?php echo e($accSliderId); ?>-wrap">
                                        <div class="overflow-hidden rounded-xl">
                                            <div class="slider-track flex transition-transform duration-500 ease-in-out"
                                                 id="<?php echo e($accSliderId); ?>-track"
                                                 data-current="0"
                                                 data-total="<?php echo e($accImages->count()); ?>">
                                                <?php $__currentLoopData = $accImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $accImg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php
                                                    $accSrc = $accImg->url
                                                ...
                                                <div class="slider-slide flex-none w-full aspect-video overflow-hidden">
                                                    <img data-src="<?php echo e($accSrc); ?>"
                                                         alt="<?php echo e($accImg->caption ?? ($acc->name ?? 'Accommodation')); ?>"
                                                         class="w-full h-full object-cover lazy-day-image">
                                                </div>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </div>
                                        </div>
                                        <?php if($accImages->count() > 1): ?>
                                        <button onclick="sliderMove('<?php echo e($accSliderId); ?>', -1)"
                                                class="slider-btn absolute left-2 top-1/2 -translate-y-1/2 bg-black/50 hover:bg-black/70 text-white rounded-full w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center transition z-10">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>
                                        </button>
                                        <button onclick="sliderMove('<?php echo e($accSliderId); ?>', 1)"
                                        ...
                                        <div class="absolute bottom-2 left-1/2 -translate-x-1/2 flex gap-1.5 z-10" id="<?php echo e($accSliderId); ?>-dots">
                                            <?php $__currentLoopData = $accImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $accImg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <button onclick="sliderGoto('<?php echo e($accSliderId); ?>', <?php echo e($loop->index); ?>)"
                                                    class="slider-dot w-2 h-2 rounded-full bg-white/60 hover:bg-white transition <?php echo e($loop->first ? 'bg-white scale-125' : ''); ?>"
                                                    aria-label="Go to photo <?php echo e($loop->iteration); ?>"></button>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                        <div class="absolute top-2 right-2 bg-black/50 text-white text-xs px-2 py-1 rounded-full z-10" id="<?php echo e($accSliderId); ?>-counter">
                                            1 / <?php echo e($accImages->count()); ?>

                                        </div>
                                        <?php endif; ?>
                                        <?php if($accImages->first()?->caption): ?>
                                        <p class="text-xs text-gray-400 mt-2 italic" id="<?php echo e($accSliderId); ?>-caption"><?php echo e($accImages->first()->caption); ?></p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <?php endif; ?>
            ...
            <section>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div class="bg-green-50 border border-green-100 rounded-xl p-5">
                        ...
                        <ul class="space-y-2">
                            <?php $__currentLoopData = explode("\n", $tour->included); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(trim($item)): ?>
                                <li class="flex items-start text-sm sm:text-base">
                                    <svg class="w-4 h-4 text-green-600 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                                    </svg>
                                    <span class="text-gray-700"><?php echo e(trim($item)); ?></span>
                                </li>
                                <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    ...
                    <div class="bg-red-50 border border-red-100 rounded-xl p-5">
                        ...
                        <ul class="space-y-2">
                            <?php $__currentLoopData = explode("\n", $tour->excluded); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(trim($item)): ?>
                                <li class="flex items-start text-sm sm:text-base">
            ...
            <?php if($tour->images && $tour->images->count() > 0): ?>
            <section>
                ...
                <div class="relative" id="tour-gallery-wrap">
                    <div class="overflow-hidden rounded-xl shadow-lg">
                        <div class="slider-track flex transition-transform duration-500 ease-in-out"
                             ...
                             data-current="0"
                             data-total="<?php echo e($tour->images->count()); ?>">
                            ...
                            <div class="slider-slide flex-none w-full aspect-video sm:aspect-[16/7]">
                                <img src="<?php echo e(asset('storage/' . $image->image_path)); ?>"
                                     ...
                                     onclick="openGallery(<?php echo e($loop->index); ?>)">
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                    <?php if($tour->images->count() > 1): ?>
                    ...
                    <div class="absolute bottom-3 left-1/2 -translate-x-1/2 flex gap-2 z-10" id="tour-gallery-dots">
                        <?php $__currentLoopData = $tour->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button onclick="sliderGoto('tour-gallery', <?php echo e($loop->index); ?>)"
                                class="slider-dot w-2.5 h-2.5 rounded-full bg-white/50 hover:bg-white transition <?php echo e($loop->first ? 'bg-white scale-125' : ''); ?>"
                                aria-label="Go to image <?php echo e($loop->iteration); ?>"></button>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    <div class="absolute top-3 right-3 bg-black/50 text-white text-xs px-2.5 py-1 rounded-full z-10" id="tour-gallery-counter">
                        1 / <?php echo e($tour->images->count()); ?>
                ...
                <div class="flex gap-2 mt-3 overflow-x-auto pb-1 snap-x" id="tour-gallery-thumbs">
                    <?php $__currentLoopData = $tour->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button onclick="sliderGoto('tour-gallery', <?php echo e($loop->index); ?>)"
                            class="gallery-thumb flex-none w-16 h-12 sm:w-20 sm:h-14 rounded-lg overflow-hidden snap-start ring-2 ring-transparent hover:ring-green-400 transition-all duration-200 <?php echo e($loop->first ? 'ring-green-500' : ''); ?>"
                            data-index="<?php echo e($loop->index); ?>"
                            aria-label="Thumbnail <?php echo e($loop->iteration); ?>">
                        <img src="<?php echo e(asset('storage/' . $image->image_path)); ?>"
                             alt="Thumbnail <?php echo e($loop->iteration); ?>"
                             class="w-full h-full object-cover">
                    </button>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
        ...
        <div class="lg:col-span-1">
            <div class="lg:sticky lg:top-24 space-y-6">
                ...
                <?php if($tour->prices && $tour->prices->count() > 0): ?>
                <div class="bg-white rounded-xl shadow-lg p-5 sm:p-6 border border-gray-200">
                    ...
                    <div class="space-y-3">
                        <?php $__currentLoopData = $tour->prices->sortBy('group_size'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $price): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex justify-between items-center p-3 sm:p-4 bg-gray-50 rounded-lg hover:bg-green-50 transition-colors cursor-pointer price-option"
                             data-group-size="<?php echo e($price->group_size); ?>"
                             data-price="<?php echo e($price->price); ?>">
                            <div class="font-semibold text-gray-900 text-sm sm:text-base"><?php echo e($price->group_size); ?></div>
                            <div class="text-right">
                                <div class="text-lg sm:text-2xl font-bold text-gray-700">$<?php echo e(number_format($price->price)); ?></div>
                ...
                <div class="bg-white rounded-xl shadow-lg p-5 sm:p-6 border border-gray-200">
                    ...
                    <div class="space-y-3 text-sm sm:text-base">
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-gray-700"><?php echo e($tour->itineraries->count() ?: 'Multi'); ?> Days Tour</span>
                        </div>
                        <?php if($tour->type): ?>
                        <div class="flex items-center gap-3">
                            <svg class="w-5 h-5 text-green-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <span class="text-gray-700"><?php echo e($tour->type); ?></span>
                        </div>
                        <?php endif; ?>
                        <div class="flex items-center gap-3">
                            <svg class="w-5 h-5 text-green-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <span class="text-gray-700"><?php echo e($tour->destinations); ?></span>
                        </div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-gray-700"><?php echo e($tour->category); ?></span>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="bg-green-700  rounded-xl shadow-lg p-5 sm:p-6 text-white">
                    ...
                    <div class="space-y-3 text-sm sm:text-base">
                        ...
                        <a href="mailto:booking@nextgensafaris.com" class="flex items-center gap-3 text-white hover:text-green-200 transition-colors">
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                            </svg>
                            booking@nextgensafaris.com
                        </a>
...
<!-- ══════════════════════════════════════════════════════
     RELATED TOURS
══════════════════════════════════════════════════════ -->
<?php if($relatedTours && $relatedTours->count() > 0): ?>
        ...
        <div class="flex gap-5 overflow-x-auto pb-4 snap-x snap-mandatory -mx-4 px-4 sm:mx-0 sm:px-0 sm:grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 sm:overflow-visible sm:gap-6 sm:snap-none"
            ...
            <div class="flex-none w-72 sm:w-auto snap-start bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 group">
                <div class="relative h-44 sm:h-48 overflow-hidden">
                    <?php if($relatedTour->featured_image): ?>
                        <img src="<?php echo e(asset('storage/' . $relatedTour->featured_image)); ?>"
                             alt="<?php echo e($relatedTour->title); ?>"
                    ...
                    <div class="absolute top-3 left-3">
                        <span class="bg-green-600 text-white px-2 py-1 rounded-full text-xs font-semibold"><?php echo e($relatedTour->category ?? 'Safari'); ?></span>
                    </div>
                    <div class="absolute top-3 right-3">
                        <span class="bg-white/90 backdrop-blur text-gray-800 px-2 py-1 rounded-full text-xs font-semibold">
                            <?php echo e($relatedTour->itineraries->count() ?: 'Multi'); ?> <?php echo e($relatedTour->itineraries->count() == 1 ? 'Day' : 'Days'); ?>

                        </span>
                    </div>
                </div>
                <div class="p-4">
                    <h3 class="text-base sm:text-lg font-bold text-gray-900 mb-2 line-clamp-2"><?php echo e($relatedTour->title); ?></h3>
                    <p class="text-gray-600 mb-3 text-xs sm:text-sm line-clamp-2"><?php echo e(Str::limit($relatedTour->description, 100)); ?></p>
                    <div class="flex items-center mb-3 text-xs sm:text-sm text-gray-500">
                        ...
                        <span class="line-clamp-1"><?php echo e($relatedTour->destinations ?: 'East Africa'); ?></span>
                    </div>
                    <div class="flex items-center justify-between mb-4">
                        <div>
                            <?php if($relatedTour->prices && $relatedTour->prices->count() > 0): ?>
                                <?php $minPrice = $relatedTour->prices->min('price'); ?>
                                <div class="flex items-baseline gap-1">
                                    <span class="text-lg sm:text-xl font-bold text-green-600">$<?php echo e(number_format($minPrice)); ?></span>
                    ...
                    <div class="flex gap-2">
                        <a href="<?php echo e(route('tours.show', $relatedTour->slug)); ?>"
                        ...
                        <button onclick="quickBook('<?php echo e($relatedTour->slug); ?>')"
...
<section id="booking" class="bg-white py-12 lg:py-16 border-t border-gray-200">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-8 sm:mb-12">
            ...
            <p class="text-base sm:text-xl text-gray-600">Ready to experience <?php echo e($tour->title); ?>? Fill out the form below and we'll get back to you instantly.</p>
        </div>
            ...
            <form id="bookingForm" class="space-y-5 sm:space-y-6">
                ...
                <div>
                    ...
                    <select id="group_size" name="group_size" required onchange="calculateTotal()"
                        ...
                        <?php $__currentLoopData = $tour->prices->sortBy('group_size'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $price): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($price->group_size); ?>" data-price="<?php echo e($price->price); ?>">
                                <?php echo e($price->group_size); ?> — $<?php echo e(number_format($price->price)); ?> per person
                            </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
...
══════════════════════════════════════════════════════════════ */
<?php if($tour->images && $tour->images->count() > 0): ?>
const _gi = <?php echo json_encode($tour->images->pluck('image_path'), 15, 512) ?>;
let _gIdx = 0;
...
function _renderGL() {
    document.getElementById('galleryImage').src = '<?php echo e(asset("storage")); ?>/' + _gi[_gIdx];
...
if (bookingForm) {
    bookingForm.addEventListener('submit', async function (e) {
        ...
        btn.disabled = true;
        try {
            const res  = await fetch('<?php echo e(route("booking.store")); ?>', { method:'POST', body: new FormData(this), headers: { 'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content, 'X-Requested-With':'XMLHttpRequest', 'Accept':'application/json' } });
            const data = await res.json();
            if (res.ok && data.success) { window.location.href = '<?php echo e(route("booking.success")); ?>'; return; }
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views/tours/show.blade.php ENDPATH**/ ?>