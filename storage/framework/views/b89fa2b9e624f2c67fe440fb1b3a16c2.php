            ...
            <div class="flex items-center gap-4 sm:gap-5">
                <div class="rounded-xl border border-gray-100 bg-white px-4 py-3 shadow-sm">
                    <img
                        ...
                        src="<?php echo e(asset('images/tato-logo.png')); ?>"
                        alt="TATO Certified"
                        loading="lazy"
                    >
                </div>
                ...
                <div class="rounded-xl border border-gray-100 bg-white px-4 py-3 shadow-sm">
                    <img
                        class="h-10 sm:h-12 w-auto opacity-80 hover:opacity-100 transition-opacity"
                        src="<?php echo e(asset('images/tanapa-logo.png')); ?>"
                        alt="TANAPA Partner"
                        loading="lazy"
                    >
                </div>
...
</section><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views\components\partners.blade.php ENDPATH**/ ?>