...
<?php $__env->startSection('title', 'Rwanda Budget Safaris - Premium Safari Tours & Wildlife Adventures in East Africa'); ?>
<?php $__env->startSection('meta_description', 'Experience unforgettable safari adventures in East Africa with Calm Africa Safaris. Expert guides, luxury accommodations, wildlife tours, cultural experiences. Book your dream African safari today!'); ?>
        ...
        <div class="hero-slide absolute inset-0 w-full h-full opacity-0 transition-opacity duration-1000 ease-in-out"
            ...
            <div class="absolute inset-0 flex items-center justify-center">
                <div class="text-center text-white max-w-4xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up animation-delay-600">
                        <a href="<?php echo e(route('tours.category', 'wildlife')); ?>" 
        ...
        <div class="hero-slide absolute inset-0 w-full h-full opacity-0 transition-opacity duration-1000 ease-in-out"
            ...
            <div class="absolute inset-0 flex items-center justify-center">
                <div class="text-center text-white max-w-4xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up animation-delay-600">
                        <a href="<?php echo e(route('tours.category', 'luxury')); ?>" 
        ...
        <div class="relative">
            ...
            <div class="package-carousel overflow-hidden">
                <div class="package-track flex transition-transform duration-500 ease-in-out" style="transform: translateX(0%);">
                    ...
                    <?php $__currentLoopData = $featuredPackages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 h-full group">
                            ...
                            <div class="p-6">
                                ...
                                <div class="flex gap-3">
                                    <a href="<?php echo e(route('tours.category', $package['category'])); ?>" 
            ...
            <div class="flex justify-center mt-8 space-x-2">
                <?php for($i = 0; $i < 4; $i++): ?>
                <button class="package-indicator w-3 h-3 rounded-full transition-colors duration-300 <?php echo e($i === 0 ? 'bg-green-600' : 'bg-gray-300'); ?>" 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views\home.blade.php ENDPATH**/ ?>