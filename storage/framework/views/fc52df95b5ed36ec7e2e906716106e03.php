<?php $__env->startSection('title', $destination->meta_title ?? $destination->name); ?>
<?php $__env->startSection('meta_description', $destination->meta_description ?? \Illuminate\Support\Str::limit($destination->description ?? $destination->detailed_overview, 160)); ?>
<?php $__env->startSection('meta_keywords', $destination->meta_keywords ?? implode(', ', array_filter([$destination->name, $destination->type, $destination->region]))); ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="hero-badges flex flex-wrap gap-2 mb-5">
                <?php if($destination->type): ?>
                    <span class="badge-type"><?php echo e($destination->type); ?></span>
                <?php endif; ?>
                <?php if($destination->region): ?>
                    <span class="badge-region"><?php echo e($destination->region); ?></span>
                <?php endif; ?>
            </div>
            ...
            <?php if($destination->description): ?>
                <p class="hero-subtitle max-w-2xl text-white/80 text-base lg:text-lg font-light leading-relaxed">
                    <?php echo e(\Illuminate\Support\Str::limit(strip_tags($destination->description), 200)); ?>
...
<nav class="breadcrumb-bar" id="breadcrumb-bar">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5">
        <div class="flex items-center space-x-2 text-sm">
            <a href="<?php echo e(route('index')); ?>" class="text-gray-400 hover:text-emerald-600 transition-colors duration-200">Home</a>
            <svg class="w-3.5 h-3.5 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
            </svg>
            <a href="<?php echo e(route('destinations.index')); ?>" class="text-gray-400 hover:text-emerald-600 transition-colors duration-200">Destinations</a>
            <svg class="w-3.5 h-3.5 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
            </svg>
            <span class="text-gray-700 font-medium"><?php echo e($destination->name); ?></span>
        </div>
    </div>
</nav>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <article class="lg:col-span-2 space-y-7">
            ...
            <div class="about-card reveal-section">
                <div class="flex items-start justify-between gap-4 flex-wrap">
                    <div>
                        <h2 class="text-xl font-bold text-gray-900 mb-1">About <?php echo e($destination->name); ?></h2>
                        <?php if($destination->best_season): ?>
                            <p class="text-sm text-gray-500 flex items-center gap-1.5 mt-2">
                                ...
                                Best time to visit: <strong class="text-emerald-700 font-semibold"><?php echo e($destination->best_season); ?></strong>
                            </p>
                        <?php endif; ?>
                    </div>
            ...
            <?php if($hasSectionContent('overview')): ?>
                <section id="overview" class="content-section">
                    ...
                    <div><?php echo $renderBlocksHtml($getSectionBlocks('overview')); ?></div>
                </section>
            <?php endif; ?>

            
            <?php if($hasSectionContent('activities')): ?>
                <section id="activities" class="content-section">
                    ...
                    <div><?php echo $renderBlocksHtml($getSectionBlocks('activities')); ?></div>
                </section>
            <?php endif; ?>

            
            <?php if($hasSectionContent('wildlife')): ?>
                <section id="wildlife" class="content-section">
                    ...
                    <div><?php echo $renderBlocksHtml($getSectionBlocks('wildlife')); ?></div>
                </section>
            <?php endif; ?>

            
            <?php if($hasSectionContent('geography')): ?>
                <section id="geography" class="content-section">
                    ...
                    <div><?php echo $renderBlocksHtml($getSectionBlocks('geography')); ?></div>
                </section>
            <?php endif; ?>

            
            <?php if($hasSectionContent('practical')): ?>
                <section id="practical" class="content-section">
                    ...
                    <div><?php echo $renderBlocksHtml($getSectionBlocks('practical')); ?></div>
                </section>
            <?php endif; ?>

            
            <?php if($hasSectionContent('accommodation')): ?>
                <section id="accommodation" class="content-section">
                    ...
                    <div><?php echo $renderBlocksHtml($getSectionBlocks('accommodation')); ?></div>
                </section>
            <?php endif; ?>

            
            <?php if($hasSectionContent('extras')): ?>
                <section id="extras" class="content-section">
                    ...
                    <div><?php echo $renderBlocksHtml($getSectionBlocks('extras')); ?></div>
                </section>
            <?php endif; ?>
            ...
            <?php if($galleryImages->isNotEmpty()): ?>
                <section id="gallery" class="content-section">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                        <?php $__currentLoopData = $galleryImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $imgPath): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="gallery-item reveal-block" style="transition-delay: <?php echo e(($i % 8) * 60); ?>ms" onclick="openGallery(<?php echo e($i); ?>)">
                                <img src="<?php echo e(asset('storage/' . $imgPath)); ?>" alt="<?php echo e($destination->name); ?> photo <?php echo e($i+1); ?>" loading="lazy">
                            </div>
            ...
            <?php if(!empty($relatedDestinations) && $relatedDestinations->count()): ?>
                <section class="content-section">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <?php $__currentLoopData = $relatedDestinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('destinations.show', $rel->slug)); ?>" class="related-card reveal-block">
                                <div class="h-40 bg-gray-100 overflow-hidden">
                                    <?php if($rel->featured_image || $rel->image): ?>
                                        <img src="<?php echo e(asset('storage/' . ($rel->featured_image ?? $rel->image))); ?>" alt="<?php echo e($rel->name); ?>" class="w-full h-full object-cover">
                                    <?php else: ?>
                                        <div class="w-full h-full bg-gradient-to-br from-emerald-300 to-blue-400 flex items-center justify-center text-white font-bold text-sm">
                                            <?php echo e(\Illuminate\Support\Str::limit($rel->name, 18)); ?>

                                        </div>
                                    <?php endif; ?>
                                </div>
                                <div class="p-4">
                                    <h4 class="font-semibold text-gray-900 text-sm mb-1"><?php echo e($rel->name); ?></h4>
                                    <p class="text-xs text-gray-500 line-clamp-2 leading-relaxed"><?php echo e(\Illuminate\Support\Str::limit($rel->description ?? '', 100)); ?></p>
                                </div>
                            </a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
        ...
        <aside class="lg:col-span-1">
            <div class="sticky top-20 space-y-5">
                ...
                <div class="sidebar-card reveal-section" style="transition-delay: 150ms;">
                    ...
                    <div class="space-y-0">
                        <div class="info-row">
                            ...
                            <span class="info-value"><?php echo e($destination->region ?? ($destination->country->name ?? '—')); ?></span>
                        </div>
                        <div class="info-row">
                            <span class="info-label">Type</span>
                            <span class="info-value"><?php echo e($destination->type ?? '—'); ?></span>
                        </div>
                        <div class="info-row">
                            <span class="info-label">Area</span>
                            <span class="info-value"><?php echo e($destination->area_size ? number_format($destination->area_size) . ' km²' : '—'); ?></span>
                        </div>
                        <?php if($destination->latitude && $destination->longitude): ?>
                            <div class="info-row">
                                <span class="info-label">Coordinates</span>
                                <span class="info-value text-xs tabular-nums"><?php echo e(number_format($destination->latitude,4)); ?>, <?php echo e(number_format($destination->longitude,4)); ?></span>
                            </div>
                        <?php endif; ?>
                    </div>
                    <div class="mt-5">
                        <a href="<?php echo e(route('custom-tour-requests.create')); ?>" class="cta-btn">
                            Plan Your Trip &rarr;
                        </a>
                    </div>
                </div>
                ...
                <?php if($destination->phone || $destination->email || $destination->website): ?>
                    <div class="sidebar-card reveal-section" style="transition-delay: 250ms;">
                        <p class="sidebar-card-header">Contact</p>
                        <div class="space-y-3 text-sm">
                            <?php if($destination->phone): ?>
                                <div class="flex items-center gap-2.5">
                                    <div class="w-8 h-8 rounded-lg bg-emerald-50 flex items-center justify-center flex-shrink-0">
                                        <svg class="w-4 h-4 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                                    </div>
                                    <a href="tel:<?php echo e($destination->phone); ?>" class="text-emerald-600 hover:text-emerald-700 font-medium transition-colors"><?php echo e($destination->phone); ?></a>
                                </div>
                            <?php endif; ?>
                            <?php if($destination->email): ?>
                                <div class="flex items-center gap-2.5">
                                    ...
                                    <a href="mailto:<?php echo e($destination->email); ?>" class="text-blue-600 hover:text-blue-700 font-medium transition-colors break-all"><?php echo e($destination->email); ?></a>
                                </div>
                            <?php endif; ?>
                            <?php if($destination->website): ?>
                                <div class="flex items-center gap-2.5">
                                    ...
                                    <a href="<?php echo e($destination->website); ?>" target="_blank" rel="noopener" class="text-purple-600 hover:text-purple-700 font-medium transition-colors"><?php echo e(parse_url($destination->website, PHP_URL_HOST)); ?></a>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
...
<?php if(isset($galleryImages) && $galleryImages->isNotEmpty()): ?>
...
/* ═══════════════════════════════════════════════════════════
   6. GALLERY MODAL
═══════════════════════════════════════════════════════════ */
const galleryImgs = <?php echo json_encode($galleryImages->all() ?? [], 15, 512) ?>;
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views\destinations\show.blade.php ENDPATH**/ ?>