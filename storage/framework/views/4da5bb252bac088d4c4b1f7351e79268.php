...
<?php $__env->startSection('title', 'Create New Tour'); ?>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <form id="create-tour-form" action="<?php echo e(route('admin.tours.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-8">
        <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            type="text" 
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-150" 
                            value="<?php echo e(old('destinations')); ?>" 
                            required
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea 
                            ...
                            rows="4" 
                            required
                            placeholder="Describe the tour experience..."><?php echo e(old('description')); ?></textarea>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea 
                            ...
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-150 resize-y" 
                            rows="4" 
                            placeholder="Enter included items, each on a new line"><?php echo e(old('included')); ?></textarea>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea 
                            ...
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-150 resize-y" 
                            rows="4" 
                            placeholder="Enter excluded items, each on a new line"><?php echo e(old('excluded')); ?></textarea>
                        <p class="mt-1 text-sm text-gray-500">Enter each item on a new line</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <input type="hidden" name="meta_keywords" id="meta_keywords" value="<?php echo e(old('meta_keywords')); ?>">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea 
                            ...
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-150 resize-y" 
                            rows="3"
                            placeholder="Brief description for search engine results"><?php echo e(old('meta_description')); ?></textarea>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const accommodationsData = <?php echo json_encode($accommodations, 15, 512) ?>;
    ...
    <?php if(old('meta_keywords')): ?>
        metaKeywords = <?php echo json_encode(array_filter(explode(',',old('meta_keywords')))); ?>;
        renderKeywords();
    <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views\admin\tours\create.blade.php ENDPATH**/ ?>