...
<?php $__env->startSection('title', 'Import SEO Page'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-3xl mx-auto px-4 py-6">
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Import SEO Page</h1>
        <a href="<?php echo e(route('admin.seo-pages.index')); ?>" class="text-sm text-gray-500 hover:text-gray-800">
            &larr; Back to Pages
        </a>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <form action="<?php echo e(route('admin.seo-pages.import.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views\admin\seo_pages\import.blade.php ENDPATH**/ ?>