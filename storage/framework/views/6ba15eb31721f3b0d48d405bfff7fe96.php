...
<?php $__env->startSection('title', 'Edit Blog Category'); ?>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex items-center space-x-3">
                <a href="<?php echo e(route('admin.blog-categories.index')); ?>" class="inline-flex items-center gap-2 px-4 py-2 bg-slate-700 text-white rounded-lg shadow hover:bg-slate-600">
                    Back to list
                </a>
            </div>
        </div>
        ...
        <form id="category-form" action="<?php echo e(route('admin.blog-categories.update', $category)); ?>" method="POST" enctype="multipart/form-data" class="bg-white border border-slate-200 rounded-lg shadow-sm p-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <input id="name" name="name" type="text" value="<?php echo e(old('name', $category->name)); ?>" required
                ...
                <div>
                    ...
                    <div class="mt-2 flex gap-2">
                        <input id="slug" name="slug" type="text" value="<?php echo e(old('slug', $category->slug)); ?>" placeholder="auto-generated from name"
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="4" class="mt-2 block w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"><?php echo e(old('description', $category->description)); ?></textarea>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input id="icon" name="icon" type="text" value="<?php echo e(old('icon', $category->icon && !Str::startsWith($category->icon, 'storage/') ? $category->icon : '')); ?>" placeholder="e.g. fas fa-leaf or heroicon-class"
                               class="mt-2 block w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500">
                            ...
                            <div id="icon-preview" class="h-12 w-12 rounded border bg-slate-50 flex items-center justify-center overflow-hidden text-slate-500" aria-hidden="true">
                                <?php if($category->icon): ?>
                                    <?php if(Str::startsWith($category->icon, 'storage/')): ?>
                                        <img src="<?php echo e(asset($category->icon)); ?>" alt="<?php echo e($category->name); ?> icon" class="h-full w-full object-contain">
                                    <?php else: ?>
                ...
                <div>
                    ...
                    <input id="order" name="order" type="number" value="<?php echo e(old('order', $category->order ?? 0)); ?>" class="mt-2 w-40 px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500">
                ...
                <div class="flex items-center gap-3 pt-4">
                    ...
                    <a href="<?php echo e(route('admin.blog-categories.index')); ?>" class="px-4 py-2 bg-slate-200 rounded-lg hover:bg-slate-300">Cancel</a>

                    
                    <form id="delete-form" method="POST" action="<?php echo e(route('admin.blog-categories.destroy', $category)); ?>" onsubmit="return confirm('Delete category &quot;<?php echo e($category->name); ?>&quot;? This cannot be undone.');">
                        <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Rwanda\resources\views\admin\blog_categories\edit.blade.php ENDPATH**/ ?>