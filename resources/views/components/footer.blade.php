        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="space-y-4">
                <div class="flex items-center space-x-2">
                    <img class="h-8 w-auto" src="{{ asset('images/logo.jpg') }}" alt="Logo">
            ...
            <div class="space-y-4">
                ...
                <ul class="space-y-3">
                    ...
                    <li>
                        <a href="{{ route('about') }}" class=" hidden text-gray-300 hover:text-white transition-colors duration-300 text-sm flex items-center group">
                            <svg class="h-4 w-4 mr-2 text-green-400 group-hover:text-green-300 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
                            About Us
                    ...
                    <li>
                        <a href="{{ route('tourist-information') }}" class="text-gray-300 hidden hover:text-white transition-colors duration-300 text-sm flex items-center group">
                            <svg class="h-4 w-4 mr-2 text-green-400 group-hover:text-green-300 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
                            Tourist Information
